...
<%@ Page Language="c#" CodeBehind="WEM010C2.aspx.cs" AutoEventWireup="false" Inherits="WebEditWs.WEM010C2" %>

<!DOCTYPE HTML >
<html>
<head>
	<title>WEM010C2 機關批次匯入作業</title>
...
<body ms_positioning="GridLayout">
	<form id="WEM010C2" method="post" runat="server" onkeyup="jf_CheckFull();">
		<!--Template V2 Generated WebForm-->
		<div id="hiddenDiv" style="z-index: -100; left: 0px; visibility: hidden; width: 100px; position: absolute; top: 0px; height: 100px">
			<asp:CustomValidator ID="Validator" runat="server" ErrorMessage="CustomValidator"></asp:CustomValidator>
			<asp:ValidationSummary ID="ValidationSummary1" runat="server"></asp:ValidationSummary>
			<asp:ListBox ID="lbReturnValue" runat="server" Width="80px"></asp:ListBox>
			<asp:TextBox ID="H_Orgno" runat="server" CssClass="hide" Width="8px"></asp:TextBox><asp:TextBox ID="H_Dept" runat="server" CssClass="hide" Width="8px" ReadOnly="True"></asp:TextBox><asp:TextBox ID="H_Owner" runat="server" CssClass="hide" Width="8px" ReadOnly="True"></asp:TextBox>
		</div>
		<div class="DivBaseTable" id="BaseTable">
			<div class="DivTable" id="MainTable">
				<div class="dTR">
					...
					<div class="dTD">
						<input id="txFile" type="file" name="txFile" runat="server" style="width: 20em" size="49">
					</div>
				</div>
				<div class="dTR">
					<div class="dTDTitle" style="width: 15em">
						<asp:Label class="InputFieldLabel" ID="Label2" runat="server">不匯入更新已存在的機關代碼：</asp:Label>
					</div>
					<div class="dTD">
