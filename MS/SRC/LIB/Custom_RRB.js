...
/*
  Date		SA		PG			NO			Desc
  1050529 	Cloud	Cloud		--			增加案次號查詢子視窗
  1060105 	Cloud	Cloud		--			調整不異動
  1060111	Cloud	Cloud		1060017 	增加案次號異動回寫基資功能
  1061220	Cloud	Cloud		1061230 	增加案次號異動檢核保存年限
  1081008	Kevin	Joe			1080339		jQuery升級3.4.1
  1090102	David	David		1090001		分類案次查詢，一律傳入年度號
  1130809	Raymond	Raymond		1130313		合併1111007(1100394), 離線版改用專用查詢分類號(EAH005.html)視窗
*/
(function() {	
	theCustom.register(CUSTOM.LOAD, function(dm) 
	{
		console.log("[RRB客製化] 載入文稿完成...");
		var dec;
	...
	theCustom.register(CUSTOM.SHOWDLG, "分類號", "查詢", function(dm) {
		...
		// 1130809 Raymond 1130313 合併1111007(1100394), 離線版改用專用視窗
    ...
    if(window.theModMgr != undefined)
        window.theModMgr.install("Custom_RRB.js").finish();
})();