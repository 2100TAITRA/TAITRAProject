...
/*
Date	SA		PG		NO			Desc
1100712	David	David	1100752		聯合大學二代升級
1120919	David	David	1120509		新增決行層級連動預排流程功能
*/

(function() {	
	theCustom.register(CUSTOM.LOAD, function(dm) 
	{
		console.log("[NUU客製化] 載入文稿完成...");
		var dec;
		...
		.register(CUSTOM.CHANGE, "決行層次",Common.fnAppLvlModify)//1120919 David 1120509 新增決行層級連動處理
		.register
		(CUSTOM.REFRESH, "發文機關", 
			[	// 發文機關異動時連動以下欄位
    ...
    if(window.theModMgr != undefined)
        window.theModMgr.install("Custom_NUU.js").finish();
})();