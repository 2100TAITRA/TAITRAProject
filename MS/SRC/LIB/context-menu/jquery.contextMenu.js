    ...
    // event handlers
        handle = {
                    ...
                    case 38: // up
                        ...
                        if (opt.isInput) {
                            if (e.keyCode === 9 && e.shiftKey) {
                                e.preventDefault();
                                if(opt.$selected) {
                                    opt.$selected.find('input, textarea, select').trigger('blur');
                                }
            ...
            prevItem: function (e) {
                ...
                if ($input.length) {
                    $input.trigger('focus'); // 2019.11.14 - 1080339 Eric, jQ3 focus() -> trigger('focus')
                }
            },
    ...
    function menuChildren(items, $children, counter) {
        ...
        $children.each(function () {
            ...
            switch (nodeName) {
                ...
                case 'menu':
                    item = {name: $node.prop('label'), items: {}};
                ...
                case 'button':
                    item = {
                        ...
                        callback: (function () {
                            return function () {
                                $node.trigger('click'); // 2019.11.14 - 1080339 Eric, jQ3 click() -> trigger('click')
                            };
                        })()
                    };
                    break;
                ...
                /* 2019.8.28 - 1080339 Eric, 此處係使用html5的<command>/<menuitem>新標籤
                   => 目前專案並未使用, 但依jQuery之定義, 相關
                      .attr('label' | 'icon' | 'type' | 'radoigroup') 應改用 .prop()
                 */
                case 'menuitem':
                case 'command':
                    ...
                    switch ($node.attr('type')) {
                        ...
                        case 'radio':
                            item = {
                                ...
                                name: label || inputLabel(node),
                                disabled: !!$node.prop('disabled'),
                                radio: !!$node.attr('name'), // 2019.8.28 - 1080339 Eric
                                value: $node.val(),
                                selected: !!$node.prop('checked')
                            };
                            break;
