    ...
    $.mobiscroll.presets.select = function (inst) {
        ...
        function genWheels() {
            ...
            $('option', cont).each(function () {
                // 2019.11.18 - 1080339 Eric, jQuery 3.0 upgarde
        ...
        function getOption() {
            // 2019.11.18 - 1080339 Eric
            //option = multiple ? (elm.val() ? elm.val()[0] : $('option', elm).attr('value')) : elm.val();
            option = multiple ? (elm.val() ? elm.val()[0] : $('option', elm).prop('value')) : elm.val();
        ...
        elm.off('.dwsel').on('change.dwsel', function () {
            ...
            prevent = false;
        }).addClass('dw-hsel').attr('tabindex', -1).closest('.ui-field-contain').enhanceWithin(); //trigger('create');
        ...
        inst.setValue = function (d, fill, time, temp, change) {
            var i,
                value,
                v = Array.isArray(d) ? d[0] : d; // 2019.9.16 - 1080339 Eric, $.isArray => Array.isArray()

            // 2019.11.18 - 1080339 Eric, jQuery 3.0 upgarde
            //option = v !== undefined ? v : $('option', elm).attr('value');
            option = v !== undefined ? v : $('option', elm).prop('value');
