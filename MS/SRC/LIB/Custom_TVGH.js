...
/*
Date	SA		PG		NO			Desc
1130207	David	David	1120589		中榮二代升級
1130223	Leslie	Leslie	1120883		[中榮]新增依設定顯示是否有待補簽公文，並提供點擊後開啟IFT940
1130426	Raymond	Raymond	中榮序97	新增類似一代雙螢幕模式的「另開附件視窗」功能
1130502	Leslie	Leslie	中榮序91	登入時預設Folder
1130614	Leslie	Leslie	中榮序128	[上線需求序11] 新增客製化設定以強制公文開啟狀態下，點擊「公文檢索」時開啟為半開模式
1130905	Leslie	Leslie	中榮序215	新增背景傳送模式可依設定，於PinCode後再檢核「SCardModuleInfo」
1140208	Leslie	Leslie	1131215		新增可依設定預設匯出彩色
*/

(function() {	
	theCustom.register(CUSTOM.LOAD, function(dm) 
	{
		console.log("[TVGH客製化] 載入文稿完成...");
		var dec;
		...
		.register(CUSTOM.CHANGE, "決行層次",Common.fnAppLvlModify)//決行層次連動處理
		.register
		(CUSTOM.REFRESH, "發文機關", 
			[	// 發文機關異動時連動以下欄位
	...
	theCustom.CustomSet = {
		ShowUnReSignCnt : true,		//1130223	Leslie[1120883]	新增依設定顯示是否有待補簽公文，並提供點擊後開啟IFT940
		CustomBtnSet : [	// 1130426 Raymond 中榮序97 新增類似一代雙螢幕模式的「另開附件視窗」功能
			{id:"openMirror",	name:"另開附件視窗",	vis:"onOpenMirrorVisible",	fn:"onOpenMirror"}
		],
		...
		DefaultAttPageByColor : true,	//1140208	Leslie[1131215]	新增可依設定預設匯出彩色
	}

	// 支援動態載入
    if(window.theModMgr != undefined)
        window.theModMgr.install("Custom_TVGH.js").finish();
})();