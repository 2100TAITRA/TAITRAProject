...
<%@ Page Language="c#" CodeBehind="ODP420.aspx.cs" AutoEventWireup="false" Inherits="OD.ODP420" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>ODP420 そゅ参璸穨</title>
...
<body ms_positioning="GridLayout">
    <form id="ODP420" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div id="MainTable" class="DivTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9em">
                        <asp:Label ID="Label2" class="RequireField" runat="server">参璸る</asp:Label>
                    </div>
                        <div class="dTD">
                            <asp:TextBox ID="txYearMonth" class="RequireFieldNumeric" TabIndex="1" runat="server" Width="3em" MaxLength="5"></asp:TextBox><br>
                            <asp:Label ID="lbMaxYM" runat="server">ヘ玡参璸程る88888る</asp:Label>
                        </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9em">
                        <asp:Label ID="Label3" runat="server" CssClass="RequireField">–秅参璸</asp:Label>
                    </div>
                    <div class="dTD">
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar">
            <asp:Button ID="btPrint" runat="server" Text="磅︽(P)" Style="display: none" Accesskey="P" Title="磅︽(ALT+P)" DefaultStyle="newmode:block;modifymode:block;" />
            <asp:Button ID="btWeek" runat="server" Text="秅参璸(W)" Style="display: none" Accesskey="W" Title="秅参璸(ALT+W)"  DefaultStyle="newmode:block;modifymode:block;" />
        </asp:Panel>
