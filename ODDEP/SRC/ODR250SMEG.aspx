...
<%@ Page Language="c#" CodeBehind="ODR250SMEG.aspx.cs" AutoEventWireup="false" Inherits="OD.ODR250SMEG" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>ODR250SMEG 公文歸檔清單列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="ODR250SMEG" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
				...
				<div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label8" runat="server">案件類型：</asp:Label>
                    </div>
                    <div class="dTD">
					<asp:RadioButtonList ID="rbCls" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="1" Selected="True">專案案件</asp:ListItem>
                            <asp:ListItem Value="2" >列管案件</asp:ListItem>
                            <asp:ListItem Value="0">雜項案</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </div>
                <div class="dTR">
