...
<%@ Page Language="c#" CodeBehind="ODR254.aspx.cs" AutoEventWireup="false" Inherits="OD.ODR254" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>ODR254 公文歸檔清單列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="ODR254" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                  ...
                  <fieldset style="width: 100%;" class="" id="SearchInfo">
                    ...
                    <div>
                        ...
                        <div class="dTD">
                            <asp:RadioButtonList ID="rbSecNo" runat="server" RepeatDirection="Horizontal">
                                ...
                                <asp:ListItem Value="1" >機密等級公文</asp:ListItem>
                    ...
                    <div>
                        <div class="dTDTitle" style="width: 6.5em">
                            <asp:Label ID="Label9" runat="server">發文類型：</asp:Label>
                        </div>
                        <div class="dTD">
                            <asp:RadioButtonList ID="rbIssue" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="0">全部</asp:ListItem>
                                <asp:ListItem Value="1" Selected="True" >一般發文</asp:ListItem>
                                <asp:ListItem Value="2" >銓審發文</asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                     </div>
                    <div>
                        <div class="dTDTitle" style="width: 6.5em">
                            <asp:Label ID="Label10" runat="server">排序方式：</asp:Label>
                        </div>
                        <div class="dTD">
                        <asp:DropDownList ID="ddlSortType1" runat="server" Width="9.5em">
                            <asp:ListItem Value="0" Selected="True">歸檔時間</asp:ListItem>
                ...
                <div class="dTR">
                    <div class="dTD">
                        <div class="hide" id="dtHead2Tool">
                            ...
                            <asp:Label class="InputFieldLabel" ID="Label3" runat="server" Width="5.5em"></asp:Label>
                        </div>
                    </div>
                </div>
                <div class="dTR">
