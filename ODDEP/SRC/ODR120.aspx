<%@ Page Language="c#" CodeBehind="ODR120.aspx.cs" AutoEventWireup="false" Inherits="OD.ODR120" %>
...
<body ms_positioning="GridLayout">
    <form id="ODR120" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div style="z-index: 101" id="MainTable" class="DivTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox Style="z-index: 0" ID="txSendDate" TabIndex="-1" runat="server" MaxLength="7" Width="4em" CssClass="DatePicker"></asp:TextBox>
                    </div>
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        ...
                        <asp:CheckBox ID="cbSortByDocNo" runat="server" Text="依公文文號排序"></asp:CheckBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label15" runat="server" CssClass="InputFieldText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:CheckBox ID="cbBSMIForm" runat="server" Text="依標檢局原有格式列印"></asp:CheckBox>
                    </div>
                </div>
            </div>
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar">
            ...
            <asp:Button ID="btODS" runat="server" Text="匯出ODS" title="匯出ODS" Style="display: none" DefaultStyle="newmode:block;modifymode:none;" />
        </asp:Panel>
