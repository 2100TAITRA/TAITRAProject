<%@ Page Language="c#" CodeBehind="ODR126.aspx.cs" AutoEventWireup="false" Inherits="OD.ODR126" %>
...
<body ms_positioning="GridLayout">
    <form id="ODR126" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div style="z-index: 101" id="MainTable" class="DivTable">
                <div class="hide">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label Style="z-index: 0" ID="Label9" runat="server">成批日期：</asp:Label>
                    </div>
                    <div class="dTD">
                    ...
                    <div class="dTD">
                        ...
                        <asp:Button ID="btGetBatchNo" runat="server" Text="帶出批號"></asp:Button>
                    </div>
                </div>
                <div class="dTR">
                    ...
                    <div class="dTD">
						...
						<asp:TextBox ID="txBatchNoE" TabIndex="-1" runat="server" MaxLength="8" Width="4.5em" CssClass="hide"></asp:TextBox>
                        <asp:ImageButton ID="btBatchNoE" TabIndex="-1" runat="server" ImageUrl="Template/images/HELPFILE_E.gif" CssClass="hide"></asp:ImageButton>
                    </div>
                </div>
                
                <div class="dTR">
                    <div style="width: 6.5em" class="dTDTitle">
                        <asp:Label ID="Label15" class="InputFieldLabel" runat="server">報表種類：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:RadioButtonList ID="rbReprotSet" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="1">送繕清單</asp:ListItem>
                            <asp:ListItem Value="2">任用動態案主管司決行彙編繕發</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </div>
                <div class="dTR" id="trFilter">
                    <div style="width: 6.5em" class="dTDTitle">
                        <asp:Label ID="Label17" class="InputFieldLabel" runat="server">成批模式：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:RadioButtonList ID="rbBatchMode" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="1">查詢加入</asp:ListItem>
                            <asp:ListItem Value="2">掃描加入</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </div>
                <div class="hide" id="DocMode">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label16" runat="server">公文文號：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <fieldset style="width: 100%;" class="" id="SearchInfo">
                <legend>查詢條件</legend>
                 <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                    ...
                    <div class="dTD">
                        ...
                        <asp:Label ID="lbSendDate2" CssClass="hide" runat="server">～</asp:Label>
                        <asp:TextBox ID="txSendDateE" runat="server" MaxLength="7" Width="4em" CssClass="hide"></asp:TextBox>
                    </div>
                     <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label Style="z-index: 0" ID="Label18" runat="server">時　　間：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="dTR">
                 ...
                 <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label21" runat="server">排　　序：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:DropDownList ID="ddlSortType" runat="server" Width="9.5em">
                            <asp:ListItem Value="0" Selected="True">傳送時間</asp:ListItem>
                ...
                <div class="hide">
                    ...
                    <div class="dTD">
                        <asp:RadioButtonList ID="rbSendTarget" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="其他單位" >其他單位</asp:ListItem>
                            <asp:ListItem Value="所屬單位">所屬單位</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </div>
                <div class="hide" id="trRcvDept">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label3" class="InputFieldLabel" runat="server">收文單位：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="hide">
                    ...
                    <div class="dTD">
                        <asp:CheckBox ID="cbIsPageByDeptNo" runat="server" CssClass="InputFieldText" Text="報表不分頁且依單位排序"></asp:CheckBox>
                    </div>
                </div>
                <div class="hide">
                    <div class="dTDTitle" style="width: 6.5em">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
        ...
        <div style="display: none; height: 42px; visibility: hidden" id="hiddenDiv">
            ...
            <asp:TextBox ID="H_txWorkMode" runat="server" CssClass="hidden"></asp:TextBox>
        </div>
        <asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar">
            <asp:Button ID="btOpen" runat="server" Text="開啟" Style="display: none" DefaultStyle="newmode:block;modifymode:none;" />
            <asp:Button ID="btSave" AccessKey="S" title="成批(ALT+S)" runat="server" Text="成批(S)" Style="display: none" DefaultStyle="newmode:block;modifymode:none;" />
            <asp:Button ID="btCancel" runat="server" Text="取消" Style="display: none" DefaultStyle="newmode:none;modifymode:block;" />
            <asp:Button ID="btSearch" Accesskey="Q" title="待送公文查詢(ALT+Q)" runat="server" Text="待送公文查詢(Q)" Style="display: none" DefaultStyle="newmode:block;modifymode:none;" />
