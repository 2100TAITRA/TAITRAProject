...
0980810 Stella  Jane    0980305     修正隱藏擬定作業時程label的問題
1040520	Kevin	Gabby	1040134		增加回傳EDT251重新搜尋
1050426 Cloud   Justin  1050087     二代公文修改
1051202	Cloud	Kevin_C	1051181		調整預定作業事項高度
...
function jf_ToolBarHandle(event)
{
    ...
    switch (xObjectName)
    {
        ...
        case "btPreview":
            ...
            //1050426 Justin 1050087 二代公文修改 
            //jf_ToolBarSubmit();
            //1050817	Leslie	修正程式邏輯，加上Break並拿掉無用的呼叫
            //jf_ToolBarSubmit(xObjectName);			
            break;
        case "btSearch":
            Page_BlockSubmit = true;
            if (jf_CheckKeyObject())
            {
                ...
                var strUrl = strUrl + "/ED/ED2/EDI200.aspx?SOURCE_ORGNO=" + strSourceOrgno + "&argMsgFrom=ODT258&argTargetNo=" + strDocNo + "&SAMLart=" + strArtifact;
...
function ClientOnLoad()
{
    ...
    if (document.all.Completed != null)
    {
        ...
        {
            //1040520 Gabby[1040134]增加回傳EDT251重新搜尋
    ...
    //1051202	Kevin_C	1051181	調整預定作業事項高度
    //if (document.all.OrgNickName && document.all.OrgNickName.value == "RRB")
    //{
        ...
        if (!rtnObj.error)
        {
            if (rtnObj.value.m_bSuccess)
            {
                ...
                if (sUnvObj !== "")
                {
                    ...
                    jf_OpenChildWin(unvUrl, "ODT259ViewDoc");
                }
            }
            else
            {
