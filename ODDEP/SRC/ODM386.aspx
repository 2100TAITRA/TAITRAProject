...
<%@ Page Language="c#" CodeBehind="ODM386.aspx.cs" AutoEventWireup="false" Inherits="OD.ODM386" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>ODM386 郵資機使用紀錄表欄位設定作業</title>
...
<body ms_positioning="GridLayout">
    <form id="ODM386" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label ID="Label1" runat="server" CssClass="KeyField">欄位代碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:DropDownList ID="dlColumn" runat="server" Width="2.5em" CssClass="KeyUpperField"></asp:DropDownList>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label ID="Label2" runat="server" CssClass="RequireField">欄位名稱：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txColumnName" runat="server" CssClass="RequireField" Width="10.5em" MaxLength="20"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="DivTable">
