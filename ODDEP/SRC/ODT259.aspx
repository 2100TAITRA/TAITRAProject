...
<%@ Page Language="c#" CodeBehind="ODT259.aspx.cs" AutoEventWireup="false" Inherits="OD.ODT259" %>

<!DOCTYPE HTML >
<html>
<head>
    <title>ODT259 特殊性案件審核作業</title>
...
<body>
    <form id="ODT259" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label17" runat="server">案　　由：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 32.5em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTDTitle" style="width: 11.5em">
                        <asp:Label ID="Label20" runat="server" Visible="False">申請前限辦日期：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label11" runat="server">申請天數：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 12em">
                        <asp:TextBox ID="txCurrExDays" TabIndex="20" CssClass="InputFieldNumeric" runat="server" ReadOnly="True" MaxLength="3" Width="2em" BackColor="LightGray"></asp:TextBox>
                        <asp:Label ID="Label12" runat="server">天</asp:Label>
                    </div>
                    <div class="dTDTitle" style="width: 11.5em">
                        <asp:Label ID="Label15" runat="server">申請後限辦日期：</asp:Label>
                    </div>
                    <div class="dTD">
