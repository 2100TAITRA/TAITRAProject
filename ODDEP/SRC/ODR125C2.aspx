<%@ Page Language="c#" CodeBehind="ODR125C2.aspx.cs" AutoEventWireup="false" Inherits="OD.ODR125C2" %>
...
<body ms_positioning="GridLayout">
    <form id="ODR125C2" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div style="z-index: 101" id="MainTable" class="DivTable">
                <div class="dTR" >
                    ...
                    <div class="dTD">
                        <asp:RadioButton ID="cbSignP" runat="server" Width="13.5em" Text="紙本簽核" Checked="true" GroupName="SignType"></asp:RadioButton>
                        <asp:RadioButton ID="cbSignE" runat="server" Width="13.5em" Text="線上簽核" GroupName="SignType"></asp:RadioButton>
                        <asp:RadioButton ID="cbSign" runat="server" Width="13.5em" Text="全部" GroupName="SignType"></asp:RadioButton>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label Style="z-index: 0" ID="Label9" runat="server">分辦日期：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="hide">
                    ...
                    <div class="dTD">
                        <asp:RadioButtonList ID="rbSendTarget" runat="server" RepeatDirection="Horizontal">
                            ...
                            <asp:ListItem Value="所屬單位" Selected="True">所屬單位</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                </div>
                ...
                <div class="dTR" id="trRcvEmp">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label7" runat="server">承辦人：</asp:Label>
                    </div>
                    <div class="dTD">
                        ...
                        <div class="GridDiv" style="height: 280px; overflow: auto" id="DIV1">
                            <asp:DataGrid ID="dg1" runat="server" AutoGenerateColumns="False" PageSize="50" CellPadding="4" GridLines="Vertical">
                                <Columns>
                                    ...
                                    <asp:TemplateColumn>
                                        <HeaderTemplate>
                                            <asp:Label ID="Label11" runat="server">承辦單位</asp:Label><br>
