<%@ Page Language="c#" CodeBehind="ODT250.aspx.cs" AutoEventWireup="false" Inherits="OD.ODT250" %>
...
<body ms_positioning="GridLayout">
    <form id="ODT250" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTDTitle" style="width: 10.5em">
                        <asp:Label ID="Label9" runat="server">專案管制前限辦日期：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="dTR" id="TrDgSche">
                    ...
                    <div class="dTD">
                        <div class="DivTable">
                            <div class="GridDiv" style="height: 6em; overflow: auto" id="DivDgSche">
                ...
                <div class="DivTable" id="divDescList">
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 10em">
        ...
        <asp:TextBox ID="H_txSignType" Style="z-index: 106; position: absolute; top: 453px; left: 102px"
            runat="server" CssClass="hidden" Width="40px"></asp:TextBox>
        <asp:TextBox ID="H_CommitInfo" Style="z-index: 106; position: absolute; top: 453px; left: 102px"
            runat="server" CssClass="hidden" Width="40px"></asp:TextBox>
