 ...
 * 1100504	Kevin	Joe  	1100473		弱掃修正Client DOM XSS
 */
...
function jf_ShowOrgDialog(argMode)
{
	...
	var ret= fnOpen("IIC000.htm" + GetAllParamStr(),"480","430"); //回傳值：name, description, Path
	return ret;
}
...
function TreeViewReload(argPage)
{
	...
	if(i != -1)
		//1100504	Joe		1100473		弱掃修正Client DOM XSS
...
function ViewerReload(argPage)
{
	...
	parent.viewer.location = encodeURI(argPage);
}
...
function CheckAccount(argCodeId, argNameId)
{
	...
	//1060613	Joe		1060456		弱掃修正--S
	sAuthws = encodeURI(sAuthws);
	argWSParam[0] = encodeURI(argWSParam[0]);
	argWSParam[1] = encodeURI(argWSParam[1]);	
	//1060613	Joe		1060456		弱掃修正--E
