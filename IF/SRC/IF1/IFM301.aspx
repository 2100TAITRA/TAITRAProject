...
<%@ Page Language="c#" CodeBehind="IFM301.aspx.cs" AutoEventWireup="false" Inherits="IF1.IFM301" Trace="false" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>IFM301 帳號維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="IFM301" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 18em;">
                        <asp:TextBox ID="txAccount" TabIndex="10" onkeypress="jf_UPPERCASE()" runat="server" Width="10em" CssClass="KeyEnUpperField" MaxLength="20"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 7em;">
                        <asp:Label ID="Label5" runat="server" Width="6em">密　　碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txMima" TabIndex="11" runat="server" Width="10em" MaxLength="32" TextMode="Password"></asp:TextBox>
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txOldMima" TabIndex="11" runat="server" Width="10em" MaxLength="32" TextMode="Password"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbSyncType" runat="server" CssClass="hide">同步型態：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 18em">
                        <asp:RadioButton ID="rbSyncType1" runat="server" CssClass="hide" Text="整合同步" GroupName="SyncType"></asp:RadioButton>
                        <asp:RadioButton ID="rbSyncType2" runat="server" CssClass="hide" Text="人工處理" GroupName="SyncType"></asp:RadioButton>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbLogonType" runat="server" CssClass="hide">密碼驗證方式：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 18em">
                        <asp:RadioButton ID="rbLogonTypeAD" runat="server" CssClass="hide" Text="網域" GroupName="LogonType"></asp:RadioButton>
                        <asp:RadioButton ID="rbLogonTypeDB" runat="server" CssClass="hide" Text="資料庫" GroupName="LogonType"></asp:RadioButton>
                    </div>
                </div>
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txBirthday" TabIndex="15" onkeypress="jf_UPPERCASE()" runat="server" Width="4em" CssClass="InputFieldNumeric" MaxLength="7"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                    ...
                    <div class="dTD" style="width: 18em">
                        ...
                        <asp:Button ID="btGetInfoByEip" runat="server" Text="從前端帶入" CssClass="hide"></asp:Button>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em;">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em;">
                        <asp:Label ID="lbFileTitle" runat="server" CssClass ="hide">ISMS流水號：</asp:Label>
                        ...
                        <asp:TextBox ID="H_IsmsSerialNo" runat="server" CssClass="hide"></asp:TextBox>
                    </div>
                    <div class="dTD" style="width: 10.5em;">
                        <asp:TextBox ID="txSerialNum" TabIndex="10" runat="server" Width="10em" MaxLength="9" CssClass ="hide"></asp:TextBox>
                    </div>
                    <div class="dTD"style="width: 10.5em;">
                        <asp:TextBox ID="txFileName" TabIndex="10" runat="server" Width="10em" MaxLength="20" CssClass ="hide" readonly ="true"  class="DisplayOnly"></asp:TextBox>
                    </div>
                    <div class="dTD" style="width: 3em;">
                        <asp:Button ID="btFileOpen" runat="server" Text="開啟" CssClass ="hide"></asp:Button>
                    </div>
                    <div class="dTD" style="width: 3em;">
                        <asp:Button ID="btFileChange" runat="server" Text="檔案" CssClass ="hide"></asp:Button>
                        <input type="file" id="fileInput" runat="server"  style="display: none" accept=".pdf" onchange="fnAddFile()"/>
                    </div>
                    <div class="dTD" style="width: 3em;">
                        <asp:Button ID="btFileDelete" runat="server" Text="刪除" CssClass ="hide"></asp:Button>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbEnableDate" runat="server" CssClass="hide" Width="6em">預計啟用日：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 18em;">
                        <asp:TextBox ID="txEnableDate" runat="server" Width="4em" CssClass="hide" MaxLength="7"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbDisableDate" runat="server" CssClass="hide" Width="6em">預計停用日：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txDisableDate" runat="server" Width="4em" CssClass="hide" MaxLength="7"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR" id="txAccExpires">
                    ...
                    <div class="dTD">
                        ...
                        <asp:TextBox ID="txAccountExpires" TabIndex="15" onkeypress="jf_UPPERCASE()" runat="server" Width="6em" CssClass="DisplayOnly DatePicker" MaxLength="7"></asp:TextBox>
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txEmpNo" TabIndex="30" onkeypress="jf_UPPERCASE()" runat="server" Width="6em" MaxLength="20"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txFax" TabIndex="30" onkeypress="jf_UPPERCASE()" runat="server" Width="6em" MaxLength="60"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        ...
                        <asp:HyperLink ID="hlSetRoleRank" runat="server" Width="5em" NavigateUrl="javascript:SetPlayRoleRank()" Visible="False">設定順序</asp:HyperLink><br>
                        <asp:HyperLink ID="hlSetRole" runat="server" Width="5em" NavigateUrl="javascript:SetPlayRole()" Visible="False">設定角色</asp:HyperLink>
                    </div>
        ...
        <asp:TextBox Style="z-index: 102; position: absolute; top: 536px; left: 768px" ID="H_Account" runat="server" CssClass="hide"></asp:TextBox>
        <asp:TextBox Style="z-index: 103; position: absolute; top: 472px; left: 768px" ID="txOldInfo" runat="server" CssClass="hide"></asp:TextBox>
        <asp:TextBox Style="z-index: 104; position: absolute; top: 536px; left: 416px" ID="H_txUnitNo" runat="server" CssClass="hide"></asp:TextBox>
    </form>
</body>
</html>
