...
序150		1130718		Zen		Alexander	(中榮)代理人設定維護畫面日期欄位長度不足7碼、調整子視窗大小
[1131183]	1140610		Leslie	Leslie	[Merge]新增行動自然人相關功能[1110117]
...
function ClientOnLoad()
{
	...
	//1140610   Leslie[1131183]	[Merge]新增行動自然人相關功能[1110117]
	sessionStorage["AuthwsURL"] = $('#hAuthwsURL').val();
	sessionStorage["Artifact"] = jf_GetArtifact();
		...
		case "btDeployPrivilege":
  		...
  		case "btSetProxy":
			...
			//1060824	Joe		1060510		修正代理取得方式--S
				...
				// 1130718 Alexander 線上序150  --中榮調整視窗大小
...
function jf_ToolBarHandle(event)
{
	...
	switch (xObjectName)
	{
		...
		case "btRegistMoica":
			Page_BlockSubmit = true;
			jf_ShowModal("/MS/RD-RegistUserMoica.html?nMode=IFM300");
			break;
	}
}
...
function SetPlayRole()
{
	...
	var param = ReplaceParamStrForOrgNo(GetAllParamStr(), document.all["dlOrgno"].value);
	//1040402	Kenny	[1030930]	增加紀錄單位管理人所屬單位至隱藏欄位，以調整IFM300C1組織樹顯示單位
...
function SetPlayRoleRank()
{
	...
	// 1130718 Alexander 線上序150  中榮調整子視窗大小(畫面顯示不完整)
