...
//1060223	David	Kevin_C	1050087(航港局496)	修IFM300C4加入功能鍵及刪除鍵沒反應的問題
/*****************************************************************************
*
*   Declaration 區
* 
...
{
    //1050725	Kenny   [1050087]	二代公文系統相關修改；移除無用CODE
...
function ClientButtonControl(e)
{
	...
	switch (xObjectName)
	{
		//1060223	Kevin_C	1050087(航港局496) 修IFM300C4加入功能鍵沒反應的問題
		case "btjoin":
...
function jf_Update_Dg(argDept,argUnit,argEmpl)
{
    ...
    alert(argDept.textContent);
	alert(argUnit.textContent);
	alert(argEmpl.textContent);
...
function jf_Delete_Dg(argIndex)
{
	...
	//1060223 Kevin_C 1050087(航港局496) 修IFM300C4刪除鍵沒反應的問題
	Page_BlockSubmit=false;
	__doPostBack("","");
}
