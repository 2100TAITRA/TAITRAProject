<%@ Page language="c#" Codebehind="IFM392.aspx.cs" AutoEventWireup="false" Inherits="IF1.IFM392" %>
<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML >
<HTML>
	<HEAD>
		<TITLE>IFM392 系統及共用章戳維護作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="IFM392" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<div class="DivBaseTable">
					...
					<div class="dTR">
						<div class="dTD">
							<asp:panel id="panel2" Runat="server">
								<FIELDSET id="newSignPlace" style="WIDTH: 48em;"><LEGEND>新增章戳區</LEGEND>
									<div class="DivTable">
										<div class="dTR">
											<div class="dTD">
												<asp:radiobutton id="rbSystemStamp" checked="true" runat="server" Text="系統章戳：" GroupName="StampType"></asp:radiobutton>
												<asp:dropdownlist id="ddlSystemStamp" runat="server" Width="6.5em">
													<asp:ListItem Value="ApprLvl1" Selected="True">第一層決行</asp:ListItem>
													<asp:ListItem Value="ApprLvl2">第二層決行</asp:ListItem>
													<asp:ListItem Value="ApprLvl3">第三層決行</asp:ListItem>
													<asp:ListItem Value="Publish">判發</asp:ListItem>
													<asp:ListItem Value="Permission">判行</asp:ListItem>
													<asp:ListItem Value="ProxyMark">代理戳記</asp:ListItem>
												</asp:dropdownlist>
											</DIV>
										</DIV>
										<div class="dTR">
											<div class="dTD">
												<asp:radiobutton id="rbToolStamp" runat="server" Text="共用章戳 群組名稱：" GroupName="StampType"></asp:radiobutton>
												<asp:textbox id="txGroupName" runat="server" Width="7.5em"></asp:textbox>
												<asp:label id="Label4" runat="server">章戳名稱：</asp:label>
												<asp:textbox id="txStampName" runat="server" Width="7.5em"></asp:textbox>
											</DIV>
										</DIV>
										<div class="dTR">
											<div class="dTD">
				...
				<div class="DivTable">
					<div class="dTR">
						<div class="dTD">
							<asp:label id="Label14" runat="server">系統章戳：</asp:label>
						</div>
					</div>
					<div class="dTR">
						<div class="dTD">
							<div class="GridDiv" style="HEIGHT: 248px" data-fixed="true">
								<asp:datagrid id="dg2" runat="server" GridLines="Vertical" CellPadding="4" PageSize="6" AutoGenerateColumns="False">
									<Columns>
				...
				<div class="DivTable">
					<div class="dTR">
						<div class="dTD">
							<asp:label id="Label15" runat="server">共用章戳：</asp:label>
						</div>
					</div>
					<div class="dTR">
						<div class="dTD">
					...
					<div class="dTR">
						<div class="dTD">
							<div class="GridDiv" style="HEIGHT: 248px">
