<%@ Page Language="c#" CodeBehind="IFM110C1.aspx.cs" AutoEventWireup="false" Inherits="IF1.IFM110C1" %>
...
<html>
<head>
    <title>IFM110C1 虛擬目錄名稱之提示子視窗</title>
...
<body>
    <form id="IFM110C1" onkeyup="jf_CheckFull();" method="post" runat="server">
                ...
                <div class="GridDiv">
                    <asp:DataGrid ID="dg1" runat="server" GridLines="Vertical" CellPadding="4" PageSize="50" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="虛擬目錄名稱">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlKey" runat="server">HyperLink</asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="說明">
                                <ItemTemplate>
                                    <asp:Label ID="lbName" runat="server" Width="9em"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
