...
<%@ Page Language="c#" CodeBehind="EAM014.aspx.cs" AutoEventWireup="false" Inherits="EA01.EAM014" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EAM014 國別代碼維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EAM014" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width:7.5em">
                        <asp:Label ID="Label1" runat="server" CssClass="KeyField">國別代碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txCountryNo" TabIndex="0" runat="server" Width="2em" CssClass="KeyEnUpperField" MaxLength="3"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width:7.5em">
                        <asp:Label ID="Label2" runat="server" CssClass="RequireField">國別名稱：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txCountryName" TabIndex="0" runat="server" Width="10.5em" CssClass="RequireField" MaxLength="100"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
