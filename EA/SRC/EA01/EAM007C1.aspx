<%@ Page Language="c#" CodeBehind="EAM007C1.aspx.cs" AutoEventWireup="false" Inherits="EA01.EAM007C1" %>
...
<html>
<head>
    <title>EAM007C1 新歸檔人員設定作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EAM007C1" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label1" runat="server" CssClass="KeyField">新歸檔人員：</asp:Label></div>
                    <div class="dTD">
                ...
                <div class="hide" id="divFirstName">
                    <div class="dTDTitle" style="width: 6.5em">
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar">
            ...
            <asp:Button ID="btTran" runat="server" Text="移交" Style="display: none" DefaultStyle="newmode:none;modifymode:none;" />
            <asp:Button ID="btInput" runat="server" Text="匯入" Style="display: none" DefaultStyle="newmode:none;modifymode:none;" />
            <asp:Button ID="btCancel" runat="server" Text="取消(X)" Style="display: none" DefaultStyle="newmode:block;modifymode:none;" />
        </asp:Panel>
    </form>
</body>
</html>
