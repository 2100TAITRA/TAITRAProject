...
1000901	        CLOUD   1000673         新增程式
1050804 Cloud   Zen     1050087         二代公文修改
...
function ReturnValue(argLink,argUESRNAME,argROLE_NO)
{
	...
	try
	{
	    ...
	    opener.document.all.lbReturnValue.options[1].value = argUESRNAME;
	    opener.document.all.lbReturnValue.options[2].value = argROLE_NO;
