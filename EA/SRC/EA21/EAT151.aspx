								...
								<asp:datagrid id="dg1" runat="server" CellPadding="0" GridLines="Vertical" AutoGenerateColumns="False" PageSize="1">
									<Columns>
										...
										<asp:TemplateColumn HeaderText="歸檔日期">
											<ItemTemplate>
												<asp:TextBox id="txFDate" runat="server" Width="62px" CssClass="DatePicker"></asp:TextBox>
												<asp:TextBox id="H_txFDate" runat="server" CssClass="hide"></asp:TextBox>
											</ItemTemplate>
										</asp:TemplateColumn>
										<asp:TemplateColumn HeaderText="預計歸檔日期">
											<ItemTemplate>
												<asp:TextBox id="txDgExtFileDate" runat="server" Width="62px" CssClass="DatePicker"></asp:TextBox>
											</ItemTemplate>
										</asp:TemplateColumn>
