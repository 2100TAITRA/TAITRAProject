<%@ Page Language="c#" CodeBehind="EAR604.aspx.cs" AutoEventWireup="false" Inherits="EA60.EAR604" %>
...
<html>
<head>
    <title>EAR604移轉移交計畫交接紀錄列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EAR604" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                        <asp:Label ID="Label3" runat="server">計畫別：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txType" runat="server" Width="4.5em" CssClass="DisplayOnly" MaxLength="20"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
