<%@ Page Language="c#" CodeBehind="EAR232.aspx.cs" AutoEventWireup="false" Inherits="EA02.EAR232" %>
...
<html>
<head>
    <title>EAR232 點收、掃描、編目日統計表</title>
...
<body ms_positioning="GridLayout">
    <form id="EAR232" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
				<div class="dTR">
					<div class="dTDTitle" style="width: 8em">
						<asp:Label ID="Label1" runat="server" CssClass="RequireField">作業日期：</asp:Label>
					</div>
				...
				<div class="dTR">
					...
					<div class="dTD" style="WIDTH: 14em">
						<asp:dropdownlist id="dlReportType" runat="server"></asp:dropdownlist>
					</div>
				</div>
				<div class="dTR">
					<div class="dTDTitle" style="WIDTH: 8em">
						<asp:label id="Label6" runat="server" >報表格式：</asp:label>
					</div>
