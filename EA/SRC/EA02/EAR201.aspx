...
<%@ Page Language="c#" CodeBehind="EAR201.aspx.cs" AutoEventWireup="false" Inherits="EA02.EAR201" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EAR201 多案次案卷標籤列印作業</title>
...
<body>
    <form id="EAR201" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            ...
            <div id="GridTable" class="DivTable">
                <asp:DataGrid ID="dg1" runat="server" CellPadding="0" GridLines="Vertical" AutoGenerateColumns="False" PageSize="4">
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="卷號 ( 年度 － 分類 － 案 － 卷 )">
                            <ItemTemplate>
                                <div>
                                    ...
                                    <asp:TextBox onblur="jf_chkVol()" ID="txVol1" TabIndex="0" onkeypress="jf_UPPERCASE();" runat="server" Width="2.5em" CssClass="InputEnOnlyUpperField" MaxLength="4"></asp:TextBox>
                                    <asp:TextBox ID="H_ClsKey1" TabIndex="-1" runat="server" Width="1.5em" CssClass="hide"></asp:TextBox>
                                </div>
                                <div>
                                    <asp:Label ID="Label6" runat="server">中：</asp:Label>
                                    <asp:TextBox onblur="jf_chkYear()" ID="txYear2" TabIndex="0" runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                                    ...
                                    <asp:TextBox onblur="jf_chkVol()" ID="txVol2" TabIndex="0" onkeypress="jf_UPPERCASE();" runat="server" Width="2.5em" CssClass="InputEnOnlyUpperField" MaxLength="4"></asp:TextBox>
                                    <asp:TextBox ID="H_ClsKey2" TabIndex="-1" runat="server" Width="1.5em" CssClass="hide"></asp:TextBox>
                                </div>
                                <div>
                                    <asp:Label ID="Label7" runat="server">左：</asp:Label>
                                    <asp:TextBox onblur="jf_chkYear()" ID="txYear3" TabIndex="0" runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                                    <asp:Label ID="Label8" runat="server">─</asp:Label>
                                    <asp:TextBox onblur="jf_IsExistClass('3')" ID="txClass3" TabIndex="0" runat="server" Width="10.5em" MaxLength="20"></asp:TextBox>
                                    <asp:Label ID="Label16" runat="server">─</asp:Label>
                                    <asp:TextBox onblur="jf_IsExistCase()" ID="txCase3" TabIndex="0" runat="server" Width="7em" MaxLength="12"></asp:TextBox>
                                    <asp:Label ID="Label15" runat="server">─</asp:Label>
                                    <asp:TextBox onblur="jf_chkVol()" ID="txVol3" TabIndex="0" onkeypress="jf_UPPERCASE();" runat="server" Width="2.5em" CssClass="InputEnOnlyUpperField" MaxLength="4"></asp:TextBox>
