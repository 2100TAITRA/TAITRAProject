...
{
	/*
	if(argCallerId == "AKT380")
	{
		
		document.all["ddlOuid"].value = jf_Trim(document.all.lbReturnValue.options[0].value);
		document.all["txDfcaseNoFld"].value = jf_Trim(document.all.lbReturnValue.options[1].value);
		document.all["txDfcaseNameFld"].value = jf_Trim(document.all.lbReturnValue.options[2].value);
