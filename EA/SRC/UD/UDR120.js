...
function Rbcheck()
{
	if ( document.all["rbPage"].checked == true )
	{
	    document.all["rbOrderDate"].disabled = false ;
   	    document.all["rbOrderDept"].disabled = false ;
		document.all["rbOrderDate"].checked	= true;
	}
	else
	{
	    document.all["rbOrderDate"].disabled = true;
   	    document.all["rbOrderDept"].disabled = true;
   	}
}
