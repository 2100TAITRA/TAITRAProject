<%@ Page language="c#" Codebehind="EAR216.aspx.cs" AutoEventWireup="false" Inherits="EA22.EAR216" %>
<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>EAR216 單位歸檔數量統計表</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="EAR216" onkeyup="jf_CheckFull();" method="post" runat="server"> <!--Template V3 Generated WebForm--> <!--#include file="../EALIB/GenericBanner.htm"-->
				...
				<div class="DivTable" id="MainTable">
					<div class="dTR">
						<div class="dTDTitle" style="WIDTH: 6.5em">
							<asp:label id="Label1" runat="server" CssClass="RequireField">統計日期：</asp:label></div>
						<div class="dTD">
