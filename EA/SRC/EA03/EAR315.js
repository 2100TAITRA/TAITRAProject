...
1120620 Cloud   Cloud   1120240         新增程式
*/
/*****************************************************************************
*
*   Declaration 區
...
function CheckBeforeSearch()
{
    ...
    if (document.all.txDateS.value != "" || document.all.txDateE.value != "") {
    	...
    	strErrMsg = EA03.EAR315.CheckDateRange(document.all.txDateS.value, document.all.txDateE.value, document.all.H_OrgNo.value).value;
    }
    else
        strErrMsg = "編目日期不可皆為為空白";
