...
1111202	Cloud	Zen     1110893         新增EAR314 編目清單列印作業
*/
...
{
    var strErrMsg = '';
    var strDateS = $('#txInpfileDateS').val();
    var strDateE = $('#txInpfileDateE').val();

    if (strDateS == '' && strDateE != '')
        $('#txInpfileDateS').val(strDateE);
    else if (strDateS != '' && strDateE == '')
        $('#txInpfileDateE').val(strDateS);
    ...
    strErrMsg += CheckDate('txInpfileDateS', '編目日期(起)', true);
    strErrMsg += CheckDate('txInpfileDateE', '編目日期(訖)', true);
