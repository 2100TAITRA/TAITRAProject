...
<%@ Page Language="c#" CodeBehind="EAR818.aspx.cs" AutoEventWireup="false" Inherits="EA80.EAR818" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EAR818 調案運用類型統計作業</title>
...
<body>
    <form id="EAR818" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar">
            ...
            <asp:Button ID="btExcel" runat="server" Text="匯出Excel(O)" DefaultStyle="newmode:block;modifymode:block;" AccessKey="O" Title="匯出Excel(ALT+O)" />
        </asp:Panel>
    </form>
</body>
</html>
