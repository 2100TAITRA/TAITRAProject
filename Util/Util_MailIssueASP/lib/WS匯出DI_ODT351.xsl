...
-->
<xsl:param name="exch"></xsl:param>
<xsl:param name="DIType"></xsl:param>
<xsl:param name="OutputSign"></xsl:param>
<xsl:param name="IssueDate"></xsl:param>
<xsl:param name="MeetingDate"></xsl:param>
...
<xsl:param name="DTD編碼">utf8</xsl:param>
		...
		<xsl:otherwise>
			<xsl:call-template name="MakeDOCTYPE">
				...
				<xsl:with-param name="dtd">
					<xsl:choose>
						<xsl:when test="$DTD編碼 = 'utf8'">99_1_utf8.dtd</xsl:when>
						<xsl:otherwise>99_1_big5.dtd</xsl:otherwise>
					</xsl:choose>
				</xsl:with-param>
			</xsl:call-template>
			<令>
	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<xsl:call-template name="MakeDOCTYPE">
				<xsl:with-param name="dtd">
					<xsl:choose>
						<xsl:when test="$DTD編碼 = 'utf8'">99_3_utf8.dtd</xsl:when>
						<xsl:otherwise>99_3_big5.dtd</xsl:otherwise>
					</xsl:choose>
				</xsl:with-param>
			</xsl:call-template>
			<公告>
