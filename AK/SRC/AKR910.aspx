...
<%@ Page Language="c#" CodeBehind="AKR910.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR910" %>

<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML>
<html>
<head>
    <title>AKR910 郎Θ计だ猂</title>
...
<body>
    <form id="AKR910" method="post" runat="server" onkeyup="jf_CheckFull();">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div id="MainTable" class="DivTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txYear2S" TabIndex="2" runat="server" CssClass="InputFieldNumeric" Width="2.5em" MaxLength="3"></asp:TextBox>
						<asp:TextBox ID="txYear2E" TabIndex="2" runat="server" CssClass="InputFieldNumeric" Width="2.5em" MaxLength="3"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                    ...
                    <div class="dTD">
                        <asp:Label ID="laMaxYearNow" runat="server">999</asp:Label>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                        <asp:Label ID="Label1" runat="server">程参璸</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:Label ID="laMinCalcYear" runat="server">999</asp:Label>
                    </div>
                </div>
            </div>
            <div class="DivTable">
