...
<%@ Page Language="c#" CodeBehind="AKR796.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR796" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>AKR796 檔管歸檔案件數據維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="AKR796" method="post" runat="server">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="組室">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lbADSort" runat="server" CssClass="hide"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="上月未上架件數">
                                <ItemTemplate>
                            ...
                            <asp:TemplateColumn HeaderText="歸檔件數">
                                <ItemTemplate>
                                    <asp:TextBox ID="txFile" runat="server" CssClass="InputFieldNumeric" Width="5.5em"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="未上架件數">
                                <ItemTemplate>
                                    <asp:TextBox ID="txUNINP" runat="server" CssClass="displayonly" Width="5.5em" ReadOnly="True"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="上架件數">
                                <ItemTemplate>
                                    <asp:TextBox ID="txINP" runat="server" CssClass="InputFieldNumeric" Width="5.5em"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="上月未歸還件數">
                                <ItemTemplate>
                                    <asp:Label ID="lbNoTret_last" runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="借檔件數">
                                <ItemTemplate>
                                    <asp:TextBox ID="txBor" runat="server" CssClass="InputFieldNumeric" Width="5.5em"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="還檔件數">
                                <ItemTemplate>
                                    <asp:TextBox ID="txRET" runat="server" CssClass="InputFieldNumeric" Width="5.5em"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="未還檔件數">
                                <ItemTemplate>
                                    <asp:TextBox ID="txNoTret" runat="server" CssClass="displayonly" Width="5.5em" ReadOnly="True"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
