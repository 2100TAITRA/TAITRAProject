<%@ Page language="c#" Codebehind="AKS502.aspx.cs" AutoEventWireup="false" Inherits="AK.AKS502" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="AKS502" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<div class="DivBaseTable" id="BaseTable">
				<div class="DivTable" id="MainTable">
					...
					<div class="dTR">
						...
						<div class="dTD">
							<cc1:combobox id="OrgName" runat="server" Width="11em" tabIndex="30" CssClass="comboBox"></cc1:combobox></div>
					</div>
					<div class="dTR">
						<div class="dTDTitle" style="WIDTH: 6.5em;">
					...
					<div class="dTR">
						<div class="dTDTitle" style="WIDTH: 6.5em">
							<asp:label id="Label3" runat="server" >歸還狀態：</asp:label></div>
						<div class="dTD">
							<asp:radiobutton id="rbSign" tabIndex="70" runat="server" Text="簽核中" GroupName="retStat"></asp:radiobutton>
							...
							<asp:CheckBox id="cbWithPaper" runat="server" Text ="(含紙本申請)" CssClass = "hidden"></asp:CheckBox>
							...
							<asp:radiobutton id="rbDue" runat="server" GroupName="retStat" Text="已逾期" tabIndex="71" CssClass = "hidden" ></asp:radiobutton>
						...
						<div class="dTD">
							<DIV class="GridDiv" style="HEIGHT: 150px">
								<asp:datagrid id="dg2" runat="server" GridLines="Vertical" CellPadding="4" BorderWidth="1px"
									...
									PageSize="50">
									<Columns>
										<asp:TemplateColumn HeaderText="序" Visible="False">
											<ItemTemplate>
												 <%# Container.ItemIndex + 1 %>
											</ItemTemplate>
										</asp:TemplateColumn>
										<asp:HyperLinkColumn DataNavigateUrlField="BOR_NO" DataNavigateUrlFormatString="javascript:ReturnValue(&quot;{0}&quot;)"
											DataTextField="BOR_NO" HeaderText="調案單號">
										</asp:HyperLinkColumn>
										<asp:BoundColumn DataField="DOC_NO" HeaderText="公文文號" Visible="False">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="FROM_SUBJECT" HeaderText="主旨" Visible="False">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="DEPT_NAME" HeaderText="調案單位">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="EMP_NAME" HeaderText="調案人">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="BOR_TYPE" HeaderText="調案方式">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="STATUS" HeaderText="狀態">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="APPLY_DATE" HeaderText="申請日期" Visible="False">
										</asp:BoundColumn>
										<asp:BoundColumn DataField="DUE_DATE" HeaderText="應歸還日期" Visible="False">
										</asp:BoundColumn>
									</Columns>
								</asp:datagrid>
							</DIV>
