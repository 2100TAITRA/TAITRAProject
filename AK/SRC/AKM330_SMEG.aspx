...
<%@ Page Language="c#" CodeBehind="AKM330_SMEG.aspx.cs" AutoEventWireup="false" Inherits="AK.AKM330_SMEG" ValidateRequest="false"  enableEventValidation="false"%>
    ...
    <form id="AKM330" method="post" runat="server">
        ...
        <div class="DivBaseTable">
            <div class="DivTable">
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox Style="ime-mode: disabled;width: 5.5em" ID="tbDOC_NO" TabIndex="1" onkeypress="jf_UPPERCASE()" runat="server" MaxLength="15">0123456789012</asp:TextBox>
                    </div>
                    ...
                    <div class="dTD" style="width: 6em">
                        <asp:TextBox Style="ime-mode: disabled;width:5.5em" ID="tbCOM_NO" TabIndex="4" onkeypress="jf_UPPERCASE()" runat="server" ></asp:TextBox>
					</div>
                ...
                <div class="dTR">
                    ...
                    <div class="hide" style="width: 10.5em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 3.5em">
                        <asp:TextBox Style="ime-mode: disabled;width: 3.5em" ID="tbSEQ" TabIndex="10" onkeypress="jf_UPPERCASE();" runat="server" MaxLength="6"></asp:TextBox>
                    </div>
                    <div class="dTD" style="width: 6em">
                    ...
                    <div class="hide" style="width: 5em">
                        <asp:TextBox Style="ime-mode: disabled;width: 4em" ID="txStockNo" runat="server"></asp:TextBox>
                    </div>
					 <div class="hide" style="width: 2.5em">
                        <asp:ImageButton ID="ibtSTOCKNO" TabIndex="-1" runat="server"  ImageUrl="template/images/HELPWIN_E.gif"></asp:ImageButton>
                    </div>
					<div class="dTD" style="width: 5em">
                ...
                <div class="dTR">  
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="lbCCardNo" runat="server" Height="11px">專案卡號：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 17em">
                        <asp:TextBox ID="tbCCardNo" TabIndex="40" runat="server" Height="22px" style="width: 4em"></asp:TextBox>
                        <asp:TextBox ID="tbCCardName" TabIndex="40" runat="server" Height="22px" style="width: 4em" CssClass="hide"></asp:TextBox>
                        <asp:Label ID="lbCCardName" runat="server" Height="11px"></asp:Label>
                    </div>
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="lbTaxIdNo" runat="server" Height="11px">統一編號：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 17em">
                        <asp:TextBox ID="tbTaxIdNo" TabIndex="40" runat="server" Height="22px" style="width: 4em"></asp:TextBox>
                        <asp:TextBox ID="tbTaxIdName" TabIndex="40" runat="server" Height="22px" style="width: 4em" CssClass="hide"></asp:TextBox>
                        <asp:Label ID="lbTaxIdName" runat="server" Height="11px"></asp:Label>
                    </div>
                </div>
                <div class="dTR">  
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label35" runat="server" Height="11px">列管編號：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 40em">
                        <asp:TextBox ID="tbManageBankNo" TabIndex="40" runat="server" Height="22px" style="width: 1.5em"></asp:TextBox>
                        <asp:TextBox ID="tbManageCaseNo" TabIndex="40" runat="server" Height="22px" style="width: 4em"></asp:TextBox>
                        <asp:TextBox ID="tbManageName" TabIndex="40" runat="server" Height="22px" style="width: 1.5em" CssClass="hide"></asp:TextBox>
                        <asp:Label ID="lbManageName" runat="server" Height="11px"></asp:Label>
                    </div>
                </div>
                <div class="dTR">  
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label36" runat="server" Height="11px">銀行代碼：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 40em">
                        <asp:TextBox ID="tbBankCode" TabIndex="40" runat="server" Height="22px" style="width: 1.5em"></asp:TextBox>
                        <asp:TextBox ID="tbBankBranchCode" TabIndex="40" runat="server" Height="22px" style="width: 2em"></asp:TextBox>
                        <asp:TextBox ID="tbBankName" TabIndex="40" runat="server" Height="22px" style="width: 1.5em" CssClass="hide"></asp:TextBox>
                        <asp:TextBox ID="tbBankBranchName" TabIndex="40" runat="server" Height="22px" style="width: 2em" CssClass="hide"></asp:TextBox>
                        <asp:Label ID="lbBankName" runat="server" Height="11px"></asp:Label>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTDTitle" style="width: 11em">
                        <asp:Label ID="Label24" runat="server" Height="11px">本文儲存位置：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 10em">
            ...
            <div style="z-index: 103; width: 506px; display: none; height: 195px; overflow: auto; top: 202px; left: 168px">
                ...
                <asp:TextBox ID="txInpFileDate" runat="server" Width="23px"></asp:TextBox>
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar">
            ...
            <asp:Button ID="btGetStockNo" runat="server" Text="櫥位號取號" AccessKey="G"  Style="display: none" DefaultStyle="newmode:none;modifymode:block;" />
