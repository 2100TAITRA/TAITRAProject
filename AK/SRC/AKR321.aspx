<%@ Page Language="c#" CodeBehind="AKR321.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR321" %>
...
<body ms_positioning="GridLayout">
    <form id="AKR320" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox class="InputEnOnlyUpperField" ID="tbFILE_VOL1" TabIndex="4" runat="server" Width="2.5em" MaxLength="4"></asp:TextBox>
			...
			<div class="DivTable">
				<div class="dTR">
					<div class="dTD">
						...
						<asp:TextBox ID="txPos" TabIndex="10" runat="server" Width="1.5em" MaxLength="2"></asp:TextBox>
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar" EnableViewState="False">
            ...
            <asp:Button runat="server" Style="display: none" ID="btPreviewOne" Text="單筆輸入(S)" AccessKey="S" Title="單筆輸入(ALT+S)" DefaultStyle="newmode:block;modifymode:block;"></asp:Button>
