...
<%@ Page Language="c#" CodeBehind="AKM330_MOCS.aspx.cs" AutoEventWireup="false" Inherits="AK.AKM330_MOCS" ValidateRequest="false" EnableEventValidation="false" %>
...
<body class="hidden" ms_positioning="GridLayout">
    <form id="AKM330_MOCS" method="post" runat="server">
            ...
            <div class="DivTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label41" runat="server" >系統別：</asp:Label>
                    </div>
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label38" runat="server">姓名：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 20em">
                        <asp:TextBox Style="width: 19em" ID="txFullName" TabIndex="-1" runat="server" MaxLength="100"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 6em">
                        <asp:Label ID="Label39" runat="server">身分證字號：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 8em">
                        <asp:TextBox Style="width: 6em" ID="txPerID" TabIndex="-1" runat="server" MaxLength="10"></asp:TextBox>
                        <asp:TextBox Style="width: 6em" ID="txPerFullID" TabIndex="-1" runat="server" MaxLength="10" CssClass="hide"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 5em">
                        <asp:Label ID="Label40" runat="server">四角號碼：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 4.5em">
                        <asp:TextBox Style="width: 3.5em" ID="txFourNum" TabIndex="-1" runat="server" MaxLength="5"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label14" runat="server">清理處置：</asp:Label>
                    </div>
                    ...
                    <div class="dTDTitle" style="width: 10em">
                        <asp:Label ID="Label15" runat="server">調整後清理處置：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 16em">
