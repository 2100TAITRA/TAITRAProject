...
1060918 Cloud   Zen     1050087     二代升級
*/
var IsServerHandling = new Boolean();
IsServerHandling = false;

//1060918 1050087 Zen 二代升級//document.all.tbTool.onbuttonclick = jf_ToolBarHandle;
    ...
    if (argCallerId == "AKP210")
    {
        if (document.all["lbReturnValue"].length == 1)
        {
            ...
            if (strMaxUseDate == "")
                ...
                //1060918 1050087 Zen 二代升級                //document.all["lbMaxYear"].innerText = "目前統計最大年度：" + strMaxUseDate.substr(0, 3) + "年";
                document.all["lbMaxYear"].textContent = "目前統計最大年度：" + strMaxUseDate.substr(0, 3) + "年";
        }
    }
}
