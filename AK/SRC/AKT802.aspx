...
<%@ Page Language="c#" CodeBehind="AKT802.aspx.cs" AutoEventWireup="false" Inherits="AK.AKT802" ValidateRequest="false" %>
        ...
        <div class="DivBaseTable">
            <div class="DivTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox ID="txBorNo" runat="server" Width="5.5em" CssClass="KeyUpperField"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 12em">
                        <asp:Label ID="Label4" runat="server">申請日期：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 10em">
                        <asp:TextBox ID="dateApply" runat="server" Width="4.5em" CssClass="DisplayOnly" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox ID="txUsageType" runat="server" Width="7em" CssClass="DisplayOnly" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 8em">
                        <asp:Label ID="lbBorFlag" runat="server">調案類型：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox ID="txBorFlag" runat="server" Width="103px" CssClass="DisplayOnly" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox ID="txFromDocNo" runat="server" Width="104px" CssClass="Displayonly" MaxLength="10" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 12em">
                        <asp:Label ID="Label15" runat="server">預計歸還日：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 10em">
                        <asp:TextBox ID="txDueDate" runat="server" Width="60px" CssClass="Displayonly" MaxLength="7" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8em">
                    ...
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox ID="txFromEmp" runat="server" Width="104px" CssClass="Displayonly" MaxLength="10" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 12em">
                        <asp:Label ID="Label19" runat="server">電　　話：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox ID="txFromTel" runat="server" Width="104px" CssClass="Displayonly" MaxLength="10" ForeColor="Navy" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8em">
                    ...
                    <div class="dTD" style="width: 10em">
                        <asp:TextBox ID="txFromNo" TabIndex="-1" runat="server" CssClass="Displayonly" ReadOnly="True" ForeColor="Navy"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8em">
            ...
            <div class="DivTable">
                ...
                <div class="GridDiv" data-fixed="true">
                    <asp:DataGrid ID="dg1" runat="server" runat="server" PageSize="5" CellPadding="2" GridLines="Vertical" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="文(編)號/檔號">
                                ...
                                <ItemTemplate>
                                    <asp:TextBox ID="txDocNo" runat="server" Width="10em" CssClass="TextLabel" MaxLength="42" ForeColor="Navy"
                                        ReadOnly="True" Height="20px"></asp:TextBox>
                                    <asp:TextBox ID="txCase" runat="server" Width="17em" CssClass="TextLabel" MaxLength="42" ForeColor="Navy"
