...
1070921 Cloud   Zen     1050087     二代升級
*/
...
function file_onchange(w, x, y, z, id)
{
    ...
    if ((parseInt(document.all[x].value) - parseInt(document.all[y].value)) < 0)
    {
    ...
    document.all[z].value = parseInt(document.all[x].value) - parseInt(document.all[y].value);
}
