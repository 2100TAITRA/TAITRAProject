<%@ Page language="c#" Codebehind="AKR330_SMEG.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR330_SMEG" %>
		...
		<form id="AKR330" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<DIV class="DivBaseTable">
				<DIV class="DivTable" id="MainTable">
					...
					<DIV class="dTR">
						<DIV class="dTDTitle" style="width: 6em; "><asp:checkbox id="cbChild" tabIndex="110" runat="server" Text="併件"></asp:checkbox></DIV>
					</DIV>
					<DIV class="dTR">
			...
			<asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar">
                ...
                <asp:Button ID="btTempNoctrl" runat="server" Text="預覽暫不列管抽卷清單" Style="display: none" DefaultStyle="newmode:block;modifymode:block;" />
			</asp:Panel>
		</form>
	</body>
</HTML>
