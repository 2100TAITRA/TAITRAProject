...
<%@ Page Language="c#" CodeBehind="AKT116_SMEG.aspx.cs" AutoEventWireup="false" Inherits="AK.AKT116_SMEG" ValidateRequest="false" %>
<!DOCTYPE HTML>
<html>
<head>
	...
	<style> <!-- 
	.DataHeader{height:36px; display:table-cell;float:left;text-align:center;margin:0 auto;BORDER-LEFT-STYLE: outset;font-size: medium;
    ...
    <form id="AKT116" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable">
            <div class="DivTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 30em">
                        <asp:TextBox Style="z-index: 0" ID="txDocSubject" TabIndex="0" runat="server" MaxLength="80" TextMode="MultiLine" Height="38px" Width="30em"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 10em">
            ...
            <div style="height: 594px" id="WorkArea" class="DivTable" >
				...
				<div class="dTR">
				<div class="dTD">
                <div id="TableTitle" style="text-align: center; background-color: #6facd5; height: 40px; margin: 0px auto">
                            ...
                            <div class="DataHeader" style="width: 1.5em ;" >序</div>
                            ...
                            <div class="DataHeader" style="width: 2em ;" >實體附件</div>
                            ...
                            <div class="DataHeader" style="width: 0em ;" id="lbCloseType" >結案別</div>
                            <div class="DataHeader" style="width: 4.5em ;" id="lbFileCls" >分類號</div>
                            <div class="DataHeader" style="width: 4.5em ;" id="lbFileCase" >案次號<BR>(卡號)</div>
                            <div class="DataHeader" style="width: 3em ;" id="lbAppUserName" >核決者</div>
                            <div class="DataHeader" style="width: 2em ;" id="lbDect" >備註</div>
                            <div class="DataHeader" style="width: 4em ;" id="lbErrMsg" >異常訊息</div>
                            <div class="DataHeader" style="width: 0em ;" id="lbDOC_D" ></div>
                    </div>
                <div style="width: 99%; height: 315px; overflow: auto;" id="divSignArea">
