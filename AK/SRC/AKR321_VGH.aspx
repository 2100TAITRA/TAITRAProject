<%@ Page language="c#" Codebehind="AKR321_VGH.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR321_VGH" %>
...
<HTML>
	<HEAD>
		<title>AKR321_VGH 案卷標籤列印作業</title>
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:textbox onkeypress="jf_UPPERCASE();" id="tbFILE_CLS1" tabIndex="2" runat="server" Width="150px" CssClass="InputFieldText" MaxLength="20" ></asp:textbox>
                    </div>
                    <div class="dTD">
                        <asp:Label onkeypress="jf_UPPERCASE();" id="lbFILE_CLS1" tabIndex="-1" runat="server" Width="250px" MaxLength="20" ReadOnly="True" ForeColor="Navy"></asp:Label>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label10" runat="server">分類號(訖)：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:textbox onkeypress="jf_UPPERCASE();" id="tbFILE_CLS2" tabIndex="2" runat="server" Width="150px" CssClass="InputFieldText" MaxLength="20" ></asp:textbox>
                    </div>
                    <div class="dTD">
                        <asp:Label onkeypress="jf_UPPERCASE();" id="lbFILE_CLS2" tabIndex="-1" runat="server" Width="250px"  MaxLength="20" ReadOnly="True" ForeColor="Navy"></asp:Label>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="tbFILE_CASE1" TabIndex="4" runat="server" Width="9.5em" CssClass="InputUpperField" MaxLength="12"></asp:TextBox>
                        <asp:ImageButton ID="btClass" runat="server" Visible="False" ImageUrl="template/images/HELPWIN_E.gif"></asp:ImageButton>
                        <asp:Label ID="lbFILE_CASE1" TabIndex="-1" runat="server" Width="10.5em"  MaxLength="20" ReadOnly="true" ForeColor="Navy" ></asp:Label>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="tbFILE_CASE2" TabIndex="4" runat="server" Width="9.5em" CssClass="InputUpperField" MaxLength="12"></asp:TextBox>
                        <asp:Label ID="lbFILE_CASE2" TabIndex="-1" runat="server" Width="10.5em" MaxLength="20" ReadOnly="true" ForeColor="Navy" ></asp:Label>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox class="InputEnOnlyUpperField" ID="tbFILE_VOL1" TabIndex="5" runat="server" Width="2.5em" MaxLength="4"></asp:TextBox>
                        <asp:Label ID="Label5" runat="server">－</asp:Label>
                        <asp:TextBox class="InputEnOnlyUpperField" ID="tbFILE_VOL2" TabIndex="6" runat="server" Width="2.5em" MaxLength="4"></asp:TextBox>
                        <asp:Label ID="lbDeptName" runat="server">單位名稱：</asp:Label>
                        <asp:TextBox ID="txDeptName" TabIndex="5" runat="server" Width="2.5em" MaxLength="2">台南</asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
			...
			<div class="DivTable">
				<div class="dTR">
					<div class="dTD">
                         <asp:Label ID="Label9" runat="server">封面標籤 起始位置：</asp:Label>
						<asp:TextBox ID="txPos" TabIndex="11" runat="server" Width="1.5em" MaxLength="2"></asp:TextBox>
						<fieldset style="width: 12.5em; height: 7.5em">
							<legend>報表格式</legend>
							<div class="dTR">
								<div class="dTD">
							...
							<div class="dTR">
								<div class="dTD">
									...
									<asp:RadioButton ID="rbVgh" runat="server" Text="總院" GroupName="gn"></asp:RadioButton>
									<asp:RadioButton ID="rbTvgh" runat="server" Text="分院" GroupName="gn"></asp:RadioButton>
									<asp:RadioButton ID="rbA4" runat="server" Text="A4格式" GroupName="gn"></asp:RadioButton>
									<asp:RadioButton ID="rbB5" runat="server" Text="B5格式" GroupName="gn"></asp:RadioButton>
								</div>
							</div>
							<div class="dTR">
								<div class="dTD">
