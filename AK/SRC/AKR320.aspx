...
<%@ Page Language="c#" CodeBehind="AKR320.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR320" %>
                        ...
                        <fieldset>
                            ...
                            <div class="MainTable" id="Table1">
                                ...
                                <div class="dTR">
                                    ...
                                    <div class="dTD">
                                        <asp:RadioButton ID="rbV_SEQ" runat="server" Width="10em" Text="直式案卷目次表" Checked="True" GroupName="a"></asp:RadioButton>
                                    </div>
                                </div>
                                <div class="dTR">
                                    <div class="dTDTitle">
