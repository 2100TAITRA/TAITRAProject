...
<body ms_positioning="GridLayout">
    <form id="AKI800" method="post" runat="server">
        ...
        <div class="DivBaseTable">
            ...
            <div style="width: 60em; height: 0.5px; margin: 0px auto; padding: 0.25px; background-color: rgba(0, 0, 128, 1); overflow: hidden;"></div>
            <asp:Panel Style="position: relative" ID="pUser1" runat="server" DESIGNTIMEDRAGDROP="17">
                <div class="DivTable" id="TblC1">
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                            <asp:Label ID="Label3" runat="server" CssClass="hide">隸屬機關：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 20em">
                            <asp:DropDownList ID="dlSOURCE_ORGNO" TabIndex="5" runat="server" CssClass="hide" AutoPostBack="True"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="dTR" id="row2">
                        ...
                        <div class="dTD" style="width: 46em">
                            ...
                            <asp:TextBox ID="tbCASE" TabIndex="50" onkeypress="jf_UPPERCASE();" runat="server" Width="6.5em" MaxLength="12" data-CN="案次(起)"></asp:TextBox>
                    ...
                    <div class="dTR">
                        ...
                        <div class="dTD" style="width: 46em">
                            ...
                            <asp:TextBox ID="txECase" TabIndex="100" onkeypress="jf_UPPERCASE();" runat="server" Width="6.5em" MaxLength="12" data-CN="案次(迄)"></asp:TextBox>
                    ...
                    <div class="dTR" style="display: none" id="row3">
                        ...
                        <div class="dTD" style="width: 30em">
                            <asp:TextBox ID="txStockNoS" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="11.5em" MaxLength="11" Font-Size="X-Small" data-CN="櫥位號(迄)"></asp:TextBox>
                            <asp:Label ID="Label50" runat="server">(起)</asp:Label>
                            <asp:Label ID="Label49" runat="server">－</asp:Label>
                            <asp:TextBox ID="txStockNoE" TabIndex="124" onkeypress="jf_UPPERCASE();" runat="server" Width="11.5em" MaxLength="11" Font-Size="X-Small" data-CN="櫥位號(迄)"></asp:TextBox>
