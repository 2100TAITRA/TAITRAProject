...
<%@ Page Language="c#" CodeBehind="AKM330_TAITRA.aspx.cs" AutoEventWireup="false" Inherits="AK.AKM330_TAITRA" ValidateRequest="false" EnableEventValidation="false" %>
...
<body class="hidden" ms_positioning="GridLayout">
    <form id="AKM330_TAITRA" method="post" runat="server">
            ...
            <div class="DivTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 4.5em">
                        <asp:Label ID="laFileCase" runat="server" Font-Size="X-Small" CssClass="hide">案次號</asp:Label>
                        <asp:Label ID="Label38" runat="server" class="RequireField" Font-Size="X-Small">國別</asp:Label>
                        </div>
                    <div class="dTD" style="width: 3.5em">
                        <asp:Label ID="Label39" runat="server" class="RequireField" Font-Size="X-Small">處別</asp:Label>
                        </div>
                    <div class="dTD" style="width: 5.5em">
                        <asp:Label ID="Label40" runat="server" class="RequireField" Font-Size="X-Small">細目號/產品別</asp:Label>
                    </div>
                    <div class="dTD" style="width: 3.5em">
                        <asp:Label ID="laFileVol" runat="server" Font-Size="X-Small">卷次號</asp:Label>
                    </div>
                    <div class="dTD" style="width: 5em">
                        <asp:Label ID="laFileSeq" runat="server" Font-Size="X-Small">件次號</asp:Label>
                    </div>
                    <div class="dTD" style="width: 5em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 4.5em">
                        <asp:TextBox Style="ime-mode: disabled; width: 0em" ID="tbCASE" TabIndex="8" runat="server" MaxLength="12" CssClass="hide"></asp:TextBox>
                        <asp:TextBox Style="ime-mode: disabled; width: 2em" ID="txCountryCode" TabIndex="8" runat="server" MaxLength="3"></asp:TextBox>
                        <asp:ImageButton ID="ibtCountryCode" TabIndex="-1" runat="server" Height="22px" ImageUrl="template/images/HELPWIN_E.gif" ></asp:ImageButton>
                    </div>
                    <div class="dTD" style="width: 3.5em">
                        <asp:TextBox Style="ime-mode: disabled; width: 2em" ID="txOfficeCode" TabIndex="8" runat="server" MaxLength="3"></asp:TextBox>
                    </div>
                    <div class="dTD" style="width: 5.5em">
                        <asp:TextBox Style="ime-mode: disabled; width: 2em" ID="txProductCode" TabIndex="8" runat="server" MaxLength="3"></asp:TextBox>
                        <asp:ImageButton ID="ibtProductCode" TabIndex="-1" runat="server" Height="22px" ImageUrl="template/images/HELPWIN_E.gif" ></asp:ImageButton>
                    </div>
                    <div class="hide" style="width: 1.75em">
                        <asp:ImageButton ID="ibtCASE" TabIndex="-1" runat="server" Height="22px" ImageUrl="template/images/HELPWIN_E.gif" CssClass="hide"></asp:ImageButton>
                    </div>
                    <div class="dTD" style="width: 3.5em">
                    ...
                    <div class="dTD" style="width: 4.5em">
                        <asp:TextBox Style="ime-mode: disabled; width: 3.5em" ID="tbSEQ" TabIndex="10" onkeypress="jf_UPPERCASE();" runat="server" MaxLength="4"></asp:TextBox>
                    </div>
                    ...
                    <div class="dTD" style="width: 3em">
                        <asp:Button ID="btAutoVol" TabIndex="-1" runat="server" Text="編目"></asp:Button>
                    </div>
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 10em">
                        <cc1:ComboBox ID="dlDept" TabIndex="10" runat="server" CssClass="comboBox" Width="7em">
                            <asp:ListItem>未繫結</asp:ListItem>
                        </cc1:ComboBox>
                    </div>
                    <div class="dTD" style="width: 6em">
