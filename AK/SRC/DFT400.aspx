...
<%@ Page Language="c#" CodeBehind="DFT400.aspx.cs" AutoEventWireup="false" Inherits="AK.DFT400" %>

<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML>
<html>
<head>
    <title>DFT400 公文批次移交作業</title>
...
<body>
    <form id="DFT400" method="post" runat="server">
                        ...
                        <fieldset >
                            ...
                            <div id="Table2" class="DivTable">
                                <div class="dTR">
                                    ...
                                    <div class="dTD">
                                        <asp:CheckBox ID="cbFix91Doc" TabIndex="50" runat="server" Text="修正91年前公文"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="dTR">
                                    <div class="dTDTitle" style="width: 7.5em">
                                    ...
                                    <div class="dTD">
                                        ...
                                        <asp:TextBox ID="txUserId" class="hide" TabIndex="10" runat="server" MaxLength="20" Width="10.5em"></asp:TextBox>
                            ...
                            <div id="Table3" class="DivTable">
                                <div class="dTR">
                                    <div class="dTDTitle" style="width: 8em">
                                        &nbsp;&nbsp;
										<asp:Label ID="Label12" TabIndex="-1" runat="server" Width="3em" CssClass="hidden"></asp:Label>
                                    </div>
                                    <div class="dTD">
                                        <asp:CheckBox ID="cbFixHDept" TabIndex="50" runat="server" Text="僅修正承辦單位"></asp:CheckBox>
                                    </div>
                                </div>
                                <div class="hide">
                                    <div class="dTDTitle" style="width: 8em">
