...
<%@ Page Language="c#" CodeBehind="AKI800_SMEG.aspx.cs" AutoEventWireup="false" Inherits="AK.AKI800_SMEG" %>
...
<body ms_positioning="GridLayout">
    <form id="AKI800" method="post" runat="server">
        ...
        <div class="DivBaseTable">
            <asp:Panel Style="position: relative" ID="pUser1" runat="server" DESIGNTIMEDRAGDROP="17">
                <div class="DivTable" id="TblC1">
                    ...
                    <div class="dTR" id="row1">
                        <div class="dTDTitle" style="width: 9.5em">
                            <asp:DropDownList ID="dlDocNo" TabIndex="5" runat="server" Width="6.5em">
                        ...
                        <div class="dTD" style="width: 40em">
                            <asp:TextBox ID="tbDOC_NOS" TabIndex="10" onkeypress="jf_UPPERCASE();" runat="server" Width="7.7em" MaxLength="15"></asp:TextBox>
                            <asp:Label ID="Label14" runat="server">(起) －</asp:Label>
                            <asp:TextBox ID="tbDOC_NOE" TabIndex="20" onkeypress="jf_UPPERCASE();" runat="server" Width="7.7em" MaxLength="15"></asp:TextBox>
                    ...
                    <div class="dTR" id="row2">
                        ...
                        <div class="dTD" style="width: 46em">
                            <asp:TextBox ID="tbYEAR" TabIndex="30" runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                            <asp:Label ID="Label1" runat="server">(年度)－</asp:Label>
                            <asp:TextBox ID="tbCLS" TabIndex="40" onkeypress="jf_UPPERCASE();" runat="server" Width="10.5em" MaxLength="20"></asp:TextBox>
                            ...
                            <asp:TextBox ID="tbCASE" TabIndex="50" onkeypress="jf_UPPERCASE();" runat="server" Width="6.5em" MaxLength="12"></asp:TextBox>
                            ...
                            <asp:TextBox ID="tbVOL" TabIndex="60" onkeypress="jf_UPPERCASE();" runat="server" Width="2.5em" MaxLength="4"></asp:TextBox>
                            <asp:Label ID="Label8" runat="server">－</asp:Label>
                            <asp:TextBox ID="tbSEQ" TabIndex="70" onkeypress="jf_UPPERCASE();" runat="server" Width="3em" MaxLength="6"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 46em">
                            <asp:TextBox onblur="PADZERO(txEYear,3);" ID="txEYear" TabIndex="80"
                                runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                            <asp:Label ID="Label25" runat="server">(年度)－</asp:Label>
                            <asp:TextBox ID="txECLS" TabIndex="90" onkeypress="jf_UPPERCASE();" runat="server" Width="10.5em" MaxLength="20"></asp:TextBox>
                            ...
                            <asp:TextBox ID="txECase" TabIndex="100" onkeypress="jf_UPPERCASE();" runat="server" Width="6.5em" MaxLength="12"></asp:TextBox>
                            ...
                            <asp:TextBox onblur="PADZERO(txEVol,4);" ID="txEVol" TabIndex="110" onkeypress="jf_UPPERCASE();" runat="server" Width="2.5em" MaxLength="4"></asp:TextBox>
                            <asp:Label ID="Label16" runat="server">－</asp:Label>
                            <asp:TextBox onblur="PADZERO(txESeq,6);" ID="txESeq" TabIndex="120" onkeypress="jf_UPPERCASE();" runat="server" Width="3em" MaxLength="6"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                            <asp:Label ID="Label55" runat="server">統一編號：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:TextBox ID="txTaxId" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="4.5em" MaxLength="8"></asp:TextBox>
                        </div>
                        <div class="dTDTitle" style="width: 13.5em">
                            <asp:Label ID="Label63" runat="server">銀行代碼：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:TextBox ID="txBankNo" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                            <asp:TextBox ID="txBankRNo" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="2.5em" MaxLength="4"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                            <asp:Label ID="Label59" runat="server">專案卡號：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 12em">
                            <asp:TextBox ID="txCCardNoS" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="4.5em" MaxLength="8"></asp:TextBox>
                            <asp:Label ID="Label61" runat="server">－</asp:Label>
                            <asp:TextBox ID="txCCardNoE" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="4.5em" MaxLength="8"></asp:TextBox>
                        </div>
                        <div class="dTDTitle" style="width: 11.5em">
                            <asp:Label ID="Label60" runat="server">列管編號：</asp:Label>
                        </div>
                        <div class="dTD">
                            <asp:TextBox ID="txManageBNoS" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                            <asp:TextBox ID="txManageCNoS" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="3.5em" MaxLength="6"></asp:TextBox>
                            <asp:Label ID="Label62" runat="server">－</asp:Label>
                            <asp:TextBox ID="txManageBNoE" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="2em" MaxLength="3"></asp:TextBox>
                            <asp:TextBox ID="txManageCNoE" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="3.5em" MaxLength="6"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR" style="display: none" id="row3">
                        ...
                        <div class="dTD" style="width: 30em">
                            <asp:TextBox ID="txStockNoS" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="11.5em" MaxLength="11" Font-Size="X-Small"></asp:TextBox>
                            <asp:Label ID="Label50" runat="server">(起)</asp:Label>
                            <asp:Label ID="Label49" runat="server">－</asp:Label>
                            <asp:TextBox ID="txStockNoE" TabIndex="122" onkeypress="jf_UPPERCASE();" runat="server" Width="11.5em" MaxLength="11" Font-Size="X-Small"></asp:TextBox>
                    ...
                    <div class="dTR">
                        ...
                        <div class="dTD" style="width: 15em">
                            <asp:TextBox ID="txKeepYearS" Style="z-index: 0" runat="server" Width="2.5em" MaxLength="2"></asp:TextBox>
                            <asp:Label ID="Label44" Style="z-index: 0" runat="server">(起) －</asp:Label>
                            <asp:TextBox ID="txKeepYearE" Style="z-index: 0" runat="server" Width="2.5em" MaxLength="2"></asp:TextBox>
                            <asp:Label ID="Label45" Style="z-index: 0" runat="server" Width="16px">(訖)</asp:Label>
                            <asp:DropDownList TabIndex="125" ID="dlKeepYear" Style="z-index: 0" runat="server" Width="3.5em">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList TabIndex="125" ID="dlClearProc" Style="z-index: 0" runat="server">
                                <asp:ListItem></asp:ListItem>
                    ...
                    <div class="dTDTitle" style="width: 9.5em">
                        <asp:DropDownList ID="dlDATE_TYPE" TabIndex="125" runat="server" Width="7.5em">
                    ...
                    <div class="dTD" style="width: 46em" id="inline_content">
                        <asp:TextBox ID="tbDATES" TabIndex="130" onkeypress="jf_UPPERCASE();" runat="server" Width="4em" MaxLength="7" CssClass="DatePicker"></asp:TextBox>
                        <asp:Label ID="Label11" runat="server">(起) －</asp:Label>
                        <asp:TextBox ID="tbDATEE" TabIndex="140" onkeypress="jf_UPPERCASE();" runat="server" Width="4em" MaxLength="7" CssClass="DatePicker"></asp:TextBox>
                    ...
                    <div class="dTR">
                        ...
                        <div class="dTD" style="width: 15em">
                            <asp:CheckBox ID="ckClosed" TabIndex="160" runat="server" Text="已結案" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="ckWorking" TabIndex="160" runat="server" Text="未結案" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbDel" TabIndex="160" runat="server" Text="已銷號" Checked="True"></asp:CheckBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="dlDOC_PROPERTY" TabIndex="125" runat="server"></asp:DropDownList>
                        </div>
                        <div class="dTDTitle" style="width: 13.5em">
                            <asp:Label ID="Label34" runat="server">業務類別：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="ddlBTypeNo" runat="server" Width="8em"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="dlDOC_SEC" TabIndex="125" runat="server" Width="5.5em">
                            ...
                            <asp:DropDownList TabIndex="125" ID="dlSECDOC_SEC" Style="z-index: 0" runat="server" Width="5.5em" CssClass="hide">
                                <asp:ListItem Selected="True"></asp:ListItem>
                                <asp:ListItem Value="2">密</asp:ListItem>
                                <asp:ListItem Value="3">機密</asp:ListItem>
                                <asp:ListItem Value="4">極機密</asp:ListItem>
                        ...
                        <div class="hide" id="RRBSection">
                            ...
                            <div class="dTD">
                                <asp:TextBox ID="txCaseNoS" runat="server" MaxLength="15" Width="8em"></asp:TextBox>
                                <asp:Label ID="lbCaseNoS" runat="server">(起)－</asp:Label>
                                <asp:TextBox ID="txCaseNoE" runat="server" MaxLength="15" Width="8em"></asp:TextBox>
                    ...
                    <div class="dTR">
                        ...
                        <div class="dTD" style="width: 11em">
                            <asp:CheckBox ID="ckOnLine" TabIndex="160" runat="server" Text="線上簽核" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="ckPaper" TabIndex="160" runat="server" Text="紙本簽核" Checked="True"></asp:CheckBox>
                        </div>
                        <div class="dTDTitle" style="width: 12.5em">
                            <asp:Label ID="Label52" runat="server">文別：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="dlDocCategory" runat="server"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="dTR" style="display: none" id="trRcvFile">
                        ...
                        <div class="dTD" style="width: 2.5em">
                            <asp:CheckBox Style="z-index: 0" ID="cbRcvFile" TabIndex="160" runat="server" Text="是"></asp:CheckBox>
                        </div>
                        <div class="dTDTitle" style="width: 9.5em">
                            <asp:Label Style="z-index: 0" ID="Label54" runat="server">併同歸檔原因：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList Style="z-index: 0" ID="dlRcvFileCond" runat="server">
                    ...
                    <div class="dTR" id="trMailRow">
                        ...
                        <div class="dTD" style="width: 40em">
                            <asp:TextBox ID="txMailRcvNo" runat="server" MaxLength="50" Width="25em"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 15em">
                            ...
                            <cc1:ComboBox TabIndex="220" ID="dlSECDEPT" runat="server" CssClass="hide"></cc1:ComboBox>
                        </div>
                        <div class="dTDTitle" style="width: 8.5em">
                            <asp:Label ID="Label13" runat="server">承辦人：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <cc1:ComboBox ID="dlUSER" TabIndex="252" runat="server" Rows="10" CssClass="comboBox" Width="4em"></cc1:ComboBox>
                            <cc1:ComboBox TabIndex="252" ID="dlSECUSER" runat="server" Rows="10" CssClass="hide"></cc1:ComboBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="dlDocSource" runat="server" Width="6.5em">
                                <asp:ListItem></asp:ListItem>
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:TextBox ID="txWorkDay" runat="server" Width="1.5em" MaxLength="3"></asp:TextBox>
                    ...
                    <div class="dTR">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:TextBox ID="tbUNIT" TabIndex="190" onkeypress="jf_UPPERCASE();" runat="server" Width="9.5em" MaxLength="15"></asp:TextBox>
                        </div>
                        <div class="dTDTitle" style="width: 13.5em">
                            <asp:Label ID="Label41" runat="server">受文者：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:TextBox ID="tbDelivUnit" TabIndex="190" onkeypress="jf_UPPERCASE();" runat="server" Width="9.5em" MaxLength="15"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 40em">
                            <asp:CheckBox ID="cbISSUE_NO" TabIndex="160" runat="server" Text="發文字號" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbFROM_NO" TabIndex="160" runat="server" Text="來文字號" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbRCV_NO" TabIndex="160" runat="server" Text="收文字號" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbNO_Upissue" TabIndex="160" runat="server" Text="上級發文字號"></asp:CheckBox>
                            <asp:TextBox ID="tbNO" TabIndex="200" onkeypress="jf_UPPERCASE();" runat="server" Width="10.5em" MaxLength="20"></asp:TextBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 46em">
                            <asp:RadioButton ID="rbUni" runat="server" Text="聯集" GroupName="rbSearch"></asp:RadioButton>
                            <asp:RadioButton ID="rbCol" runat="server" Text="交集" GroupName="rbSearch"></asp:RadioButton>
                            <asp:TextBox ID="tbKEYWORD" TabIndex="180" onkeypress="jf_UPPERCASE();" runat="server" Width="20em" MaxLength="50"></asp:TextBox>(輸入多筆時，請用","隔開)
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 40em">
                            <asp:CheckBox TabIndex="150" ID="ckInSubject" runat="server" CssClass="hide" Text="查詢密件案由(主旨)"></asp:CheckBox>
                            <asp:CheckBox ID="ckSubject" TabIndex="150" runat="server" Text="案由(主旨)" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="ckCaseName" TabIndex="160" runat="server" Text="案名"></asp:CheckBox>
                            <asp:CheckBox ID="cbOtherSubject" TabIndex="160" runat="server" Text="並列及其他案由"></asp:CheckBox>
                            ...
                            <asp:CheckBox ID="cbUNIT" TabIndex="160" runat="server" Text="來文者"></asp:CheckBox>
                            <asp:CheckBox ID="cbDelivUnit" TabIndex="160" runat="server" Text="受文者"></asp:CheckBox>
                        </div>
                    </div>
                    <div class="dTR" id="trFileRow">
                        ...
                        <div class="dTD" style="width: 13em">
                            <asp:CheckBox ID="cbRpdFile" TabIndex="160" runat="server" Text="來文電子檔"></asp:CheckBox>
                            <asp:CheckBox ID="cbEditFile" TabIndex="160" runat="server" Text="稿件電子檔"></asp:CheckBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 12em">
                            <asp:CheckBox ID="cbOrgStore" TabIndex="160" runat="server" Text="機關庫房" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbUnitStore" TabIndex="160" runat="server" Text="單位庫房" Checked="True"></asp:CheckBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:CheckBox ID="cbSend" runat="server" Text="發文" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbSave" runat="server" Text="存查" Checked="True"></asp:CheckBox>
                        </div>
                        <div class="dTDTitle" style="width: 13.5em">
                            <asp:Label ID="Label37" runat="server">續辦：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:CheckBox ID="cbCaseConY" runat="server" Text="有" Checked="True"></asp:CheckBox>
                            <asp:CheckBox ID="cbCaseConN" runat="server" Text="無" Checked="True"></asp:CheckBox>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="width: 9.5em">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="ddlIssueProperty" runat="server" Width="8em"></asp:DropDownList>
                        </div>
                        <div class="dTDTitle" style="width: 13.5em">
                            <asp:Label ID="Label40" runat="server">公文類別：</asp:Label>
                        </div>
                        <div class="dTD" style="width: 10em">
                            <asp:DropDownList ID="dlDocType" runat="server" Width="3.5em">
            ...
            <asp:Panel ID="pPer1" runat="server">
                <div class="DivTable" id="TblC3">
                    <div class="dTR" id="Tr2">
                        ...
                        <div class="dTD" style="width: 10em">
                            <asp:TextBox onblur="PADZERO(txCustomYear,3);" ID="txCustomYear" TabIndex="210"
                                runat="server" Width="3.5em" CssClass="InputFieldLabel" MaxLength="3"></asp:TextBox>
            ...
            <div class="DivTable" id="TblC5">
                ...
                <div class="dTR" id="Tr10">
                    ...
                    <div class="dTD" style="width: 10em">
                        <asp:DropDownList ID="dlNumPerPage" TabIndex="260" runat="server" Width="4.5em">
                    ...
                    <div class="dTD" style="width: 25em">
                        <asp:DropDownList ID="dlORDER" TabIndex="270" runat="server" Width="8em">
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V2_GenericBannerToolBar">
            ...
            <asp:Button ID="btSearchDestroy" runat="server" Text="查詢已銷毀公文(U)" AccessKey="U" Style="display: none" DefaultStyle="newmode:block;modifymode:none;" />
        </asp:Panel>
    </form>
</body>
</html>
