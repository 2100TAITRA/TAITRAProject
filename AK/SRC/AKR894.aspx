<%@ Page Language="c#" CodeBehind="AKR894.aspx.cs" AutoEventWireup="false" Inherits="AK.AKR894" %>
...
<html>
<head>
    <title>AKR894 檔案申請應用分類數量統計表</title>
...
<body>
    <form id="AKR894" method="post" runat="server" onkeyup="jf_CheckFull();">
            ...
            <div id="MainTable" class="DivTable">
                ...
                <fieldset style="width: 13.5em; height: 4em">
                    ...
                    <div id="Table2">
                        <div class="dTR">
                            <div class="dTD">
                                <asp:RadioButton ID="rb1" runat="server" GroupName="GN" Text="類"></asp:RadioButton>
                                <asp:RadioButton ID="rb2" runat="server" GroupName="GN" Text="綱"></asp:RadioButton>
                                <asp:RadioButton ID="rb3" runat="server" GroupName="GN" Text="目"></asp:RadioButton>
                                <asp:RadioButton ID="rb4" runat="server" GroupName="GN" Text="節"></asp:RadioButton>
                                <asp:RadioButton ID="rb5" runat="server" GroupName="GN" Text="項"></asp:RadioButton>
                            </div>
                        </div>
                    </div>
                </fieldset>
