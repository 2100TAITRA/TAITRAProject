<%@ Page language="c#" Codebehind="TBR110.aspx.cs" AutoEventWireup="false" Inherits="TB1.TBR110" %>
<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>TBR110 單位收發文統計表列印作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="TBR110" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<div class="DivBaseTable" id="BaseTable">
                <div class="DivTable" id="MainTable">
                    ...
                    <div class="dTR">
                        <div class="dTDTitle" style="WIDTH: 6em">
                            <asp:label id="Label2" runat="server">統計日期：</asp:label>
                        </div>
                        <div class="dTD">
