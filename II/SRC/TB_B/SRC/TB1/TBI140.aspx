        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" style="width: 90%">
                ...
                <div class="dTD" style="border-width: 3px; border-style: solid; border-color: black; padding: 5px;">
                    ...
                    <div class="dTR">
                        <div class="dTR">
                            <div class="dTDTitle" style="border-width: 1px; border-style: solid; border-color: black; padding: 5px; width: 100px;">
                        ...
                        <div class="dTR">
                            <div class="dTDTitle" style="border-width: 1px; border-style: solid; border-color: black; padding: 5px; width: 100px; height: 153px">
                    ...
                    <div id="hiddenDiv" style="z-index: -100; left: 0px; visibility: hidden; width: 100px; position: absolute; top: 0px; height: 1px">
