...
<%@ Page language="c#" Codebehind="TBR130.aspx.cs" AutoEventWireup="false" Inherits="TB1.TBR130" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>TBR130 人員查閱明細表列印作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="TBR130" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<div class="DivBaseTable" id="BaseTable">
                <div class="DivTable" id="MainTable">
                    <div class="dTR">
                        ...
                        <div class="dTD">
                            <asp:dropdownlist id="dlDept" runat="server" Width="7em"></asp:dropdownlist>
                        </div>
                    </div>
                    <div class="dTR">
                        <div class="dTDTitle" style="WIDTH: 6em;">
