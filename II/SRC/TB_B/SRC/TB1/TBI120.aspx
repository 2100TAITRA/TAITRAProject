...
<body style="background-color: #99ccff">
	<form id="TBI120" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<div class="DivTable" style="width: 100%">
				...
				<div class="dTR">
					<div class="dTD DgSelectToolBar" id="tbSelect2" style="background-color: #99ccff; width: 100%">
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_01-1.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btSelectAll" ToolTip="勾選所有的選項"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_02-1.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btSelectInverse" ToolTip="反向選取"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_03-1.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btSelectClear" ToolTip="清除勾選所有的選項"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_07-04.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btDownLoad" AccessKey="D" ToolTip="下載勾選的公告(ALT+D)"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_05-1.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btView" AccessKey="V" ToolTip="檢視第一筆明細(ALT+V)"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_07-1.gif" class="HIDE" ID="btTranToOD" ToolTip="轉入公文系統"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_07-03.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btReLoad" AccessKey="F" ToolTip="重新整理(ALT+F)"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_08-1.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btPrint" AccessKey="P" ToolTip="公布清單預覽(ALT+P)"></asp:ImageButton>
						<asp:ImageButton runat="server" ImageUrl="../IMAGE/bt_07-05.gif" DefaultStyle="cursor:hand;border-color:#99ccff;"
							ID="btSetTbReaded" AccessKey="R" ToolTip="設為已讀(ALT+R)"></asp:ImageButton>
					</div>
				</div>
				<div class="dTR">
					<asp:Label ID="lbMessage" runat="server" CssClass="hide" Font-Names="細明體"></asp:Label>
					<div class="GridDiv">
						<asp:DataGrid ID="dg1" runat="server" Width="100%" Height="2px" PageSize="30" AutoGenerateColumns="False"
							GridLines="Vertical" CellSpacing="0" CellPadding="0" BorderWidth="1px" ForeColor="Black" BorderColor="#DEDFDE" BorderStyle="None" BackColor="White">
							<Columns>
								...
								<asp:TemplateColumn HeaderText="公告編號">
									<ItemTemplate>
										<asp:Label ID="lbBulletinId" runat="server" CssClass="InputFieldLabel"></asp:Label>
								...
								<asp:TemplateColumn HeaderText="來文機關">
									...
									<ItemTemplate>
										<asp:Label ID="lbFromOrgName" runat="server" CssClass="InputFieldLabel"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="公告主旨">
									<ItemTemplate>
										<div class="big">
											<asp:HyperLink ID="hlSubject" TabIndex="0" runat="server" CssClass="InputFieldLabel"></asp:HyperLink>
										</div>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="發布單位">
									<ItemTemplate>
										<asp:Label ID="lbUnitName" runat="server" CssClass="InputFieldLabel"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="承辦單位">
									<ItemTemplate>
										<asp:Label ID="lbRpsDept" runat="server" CssClass="InputFieldLabel"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="承辦人">
									<ItemTemplate>
										<asp:Label ID="lbAccount" runat="server" CssClass="InputFieldLabel"
											Width="90px"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="公布日期">
									<ItemTemplate>
										<asp:Label ID="lbPasteDate" runat="server" CssClass="InputFieldLabel"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn HeaderText="公告對象">
									<ItemTemplate>
										<asp:Label ID="lbAllow" runat="server" CssClass="InputFieldLabel"></asp:Label>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
						</asp:DataGrid>
		...
		<asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar">
			<span runat="server" cssclass="InputFieldLabel">電子公布欄系統</span>
		</asp:Panel>
