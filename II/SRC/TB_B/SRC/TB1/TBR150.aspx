<%@ Page Language="c#" CodeBehind="TBR150.aspx.cs" AutoEventWireup="false" Inherits="TB1.TBR150" %>
...
<html>
<head>
    <title>TBR150 第三類發文月報表列印作業</title>
...
<body>
    <form id="TBR150" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txStartDate" TabIndex="0" runat="server" Width="3em" CssClass="RequireFieldNumeric" MaxLength="5"></asp:TextBox>(EX：09502)&nbsp;&nbsp;&nbsp;
                    </div>
                </div>
            </div>
        </div>
