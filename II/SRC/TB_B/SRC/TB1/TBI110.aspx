...
<body background="../image/obj_04.gif" ms_positioning="GridLayout" style="width: 270px">
	<form id="TBI110" method="post" runat="server" style="width: 270px">
		<!--Template V3 Generated WebForm-->
		<div class="DivBaseTable" id="BaseTable" style="width: 270px">
			<div class="dTR">
			...
			<div id="divAdvance" class="hide" style="width: 190px">
			...
			<div id="dlgASPXPage" style="display: none; width: 99%; height: 99%; padding: 0px;">
				<div class="pane" style="width: 101%; height: 101%; overflow-y: hidden; overflow-x: hidden; -webkit-overflow-scrolling: touch;">
					<iframe class="aspx_page_content" style="width: 270px; height: 600px;"></iframe>
				</div>
