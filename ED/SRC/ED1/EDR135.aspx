...
<%@ Page Language="c#" CodeBehind="EDR135.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR135" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR135 來文密件統計表列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR135" onkeyup="jf_CheckFull();" method="post" runat="server">
