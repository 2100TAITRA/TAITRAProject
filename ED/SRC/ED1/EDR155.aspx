...
<%@ Page Language="c#" CodeBehind="EDR155.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR155" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR155 部長交辦函件辦理情形報表列印作業</title>
...
<body>
    <form id="EDR155" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <cc1:ComboBox ID="dlDept" CssClass="comboBox" runat="server"></cc1:ComboBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                    ...
                    <div class="dTD">
                        <asp:RadioButton ID="rbClose" runat="server" Text="已結案" GroupName="ReportType"></asp:RadioButton>
                        <asp:RadioButton ID="rbWait" runat="server" Text="未結案" GroupName="ReportType"></asp:RadioButton>
                    </div>
                </div>
            </div>
        </div>
