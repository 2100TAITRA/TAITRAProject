...
<%@ Page Language="c#" CodeBehind="EDR152.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR152" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR152 總收文件數統計表列印作業</title>
...
<body>
    <form id="EDR152" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6em">
                        <asp:Label ID="Label2" runat="server">收文人員：</asp:Label>
                    </div>
                    <div class="dTD">
