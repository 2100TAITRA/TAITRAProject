...
<%@ Page Language="c#" CodeBehind="EDR150.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR150" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR150 收文統計清單列印作業</title>
...
<body>
    <form id="EDR150" onkeyup="jf_CheckFull();" method="post" runat="server">
