<%@ Page Language="c#" CodeBehind="EDR160.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR160" %>
...
<html>
<head>
    <title>EDR160 總收分文使用時間統計表</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR160" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label ID="Label3" runat="server">分文時間：</asp:Label>
                    </div>
                    <div class="dTD">
