...
<%@ Page Language="c#" CodeBehind="EDR153.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR153" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR153 收發文統計表列印作業</title>
...
<body>
    <form id="EDR153" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        ...
                        <asp:TextBox ID="txDate_EXAM" runat="server" Width="3em" CssClass="RequireFieldNumeric" MaxLength="5"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
