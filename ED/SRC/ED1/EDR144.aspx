<%@ Page Language="c#" CodeBehind="EDR144.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR144" %>
...
<html>
<head>
    <title>EDR144 紙本來文掃描線上簽核公文查詢作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR144" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txDocNoS" TabIndex="0" runat="server" Width="5.5em" CssClass="InputFieldNumeric" MaxLength="10"></asp:TextBox>
                        <asp:Label ID="Label4" runat="server">～</asp:Label>
                        <asp:TextBox ID="txDocNoE" TabIndex="0" runat="server" Width="5.5em" CssClass="InputFieldNumeric" MaxLength="10"></asp:TextBox>
                    </div>
                </div>
            </div>
                    ...
                    <asp:DataGrid ID="dg1" runat="server" GridLines="Vertical" AutoGenerateColumns="False" EnableViewState="False" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="來文機關">
                                <ItemTemplate>
                                    <asp:Label ID="lbFormOrgName" runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:TemplateColumn HeaderText="主旨">
                                <ItemTemplate>
                                    <asp:Label ID="lbFromSubject" Style="overflow: hidden; display: inline-block; height: 1.4em" runat="server" CssClass="PopUp"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
