<%@ Page Language="c#" CodeBehind="EDR138.aspx.cs" AutoEventWireup="false" Inherits="ED1.EDR138" %>
...
<html>
<head>
    <title>EDR138 公文收文傳送類別統計表列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR138" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div id="MainTable" class="DivTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label ID="Label1" runat="server" CssClass="RequireField">統計期間：</asp:Label>
                    </div>
                    <div class="dTD">
