...
<%@ Page language="c#" Codebehind="EDM097.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM097" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>EDM097 指定回閱對象設定作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="EDM097" onkeyup="jf_CheckFull();" method="post" runat="server">
                    ...
                    <div class="dTR">
                        <div class="dTD">
                            <DIV class="GridDiv" style="HEIGHT: 400px;">
                                <asp:datagrid id="dg1" runat="server" PageSize="15" AutoGenerateColumns="False"
