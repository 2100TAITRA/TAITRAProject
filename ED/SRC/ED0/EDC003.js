...
1031020	-----	Cloud	1030659			增加回傳單位代碼
1050617 David   Zen     1050087         二代公文修改
...
function ReturnValue(argLink,argDept)
{
	try
	{
		//1031020	-----	Cloud	1030659			增加回傳單位代碼
	    ...
	    opener.document.all.lbReturnValue.options[1].value = argDept;
	    opener.window.CallBack("EDC003");
	    opener.window.focus();
	    close();
	}
	catch (e) {
