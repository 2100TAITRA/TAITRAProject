...
<%@ Page Language="c#" CodeBehind="EDM060.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM060" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDM060 公文遞送方式及郵資設定維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDM060" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="lbNo" runat="server" CssClass="KeyField">遞送代碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txPostNo" onkeyup="ED_jf_CheckFull()" TabIndex="0" runat="server" Width="1.5em" CssClass="ED_KeyField" MaxLength="2"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="lbName" runat="server" CssClass="RequireField">遞送名稱：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txPostName" TabIndex="1" runat="server" Width="10.5em" CssClass="RequireField" MaxLength="10"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txDefaultNo" onkeyup="ED_jf_CheckFull()" TabIndex="2" runat="server" Width="1.5em" CssClass="ED_InpField" MaxLength="2"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
