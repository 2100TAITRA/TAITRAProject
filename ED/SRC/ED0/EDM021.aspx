...
<%@ Page Language="c#" CodeBehind="EDM021.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM021" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDM021 單位檔號維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDM021" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 3.5em">
                        <asp:Label ID="lbType" runat="server" CssClass="RequireField">單位：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:DropdownList ID="dlDept" runat="server" CssClass="RequireField" Width="9.5em"></asp:DropdownList>
                    </div>
                </div>
            </div>
            <div class="DivTable" id="GridTable">
                <div class="GridDiv" style="height: 18em">
                    <asp:DataGrid ID="dg1" runat="server" PageSize="10" AutoGenerateColumns="False" GridLines="Vertical" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="檔號">
                                <ItemTemplate>
                                    <asp:TextBox ID="txOuStoreNo" runat="server" Width="2em" MaxLength="2"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="檔案名稱">
                                <ItemTemplate>
                                    <asp:TextBox ID="txOuStoreName" runat="server" Width="5.5em" MaxLength="10"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
