...
<%@ Page Language="c#" CodeBehind="EDM040.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM040" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDM040 郵件類別代碼維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDM040" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txTypeNo" onkeyup="ED_jf_CheckFull()" TabIndex="1" runat="server" Width="1.5em" CssClass="ED_KeyField" MaxLength="2"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txTypeName" onkeyup="ED_jf_CheckFull()" TabIndex="2" runat="server" Width="4.5em" CssClass="RequireField" MaxLength="20"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
