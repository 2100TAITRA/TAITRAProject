...
<%@ Page Language="c#" CodeBehind="EDM010.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM010" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDM010 公文機密等級代碼維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDM010" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8.5em">
                        <asp:Label ID="Label1" runat="server" CssClass="KeyField">機密代碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txSecNo" Width="1em" onkeyup="ED_jf_CheckFull()" TabIndex="0" runat="server" CssClass="ED_KeyField" MaxLength="1"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8.5em">
                        <asp:Label ID="Label2" runat="server" CssClass="RequireField">機密名稱：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txSecName" Width="5.5em" onkeyup="ED_jf_CheckFull()" TabIndex="1" runat="server" CssClass="RequireField" MaxLength="10"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txInnerNo" Width="1em" onkeyup="ED_jf_CheckFull()" TabIndex="2" runat="server" MaxLength="1"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txInnerName" Width="5.5em" onkeyup="ED_jf_CheckFull()" TabIndex="3" runat="server" MaxLength="10"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8.5em">
                    ...
                    <div class="dTD">
                        <asp:RadioButtonList ID="rbDefaultCode" runat="server" RepeatDirection="Horizontal">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 8.5em">
                        <asp:Label ID="Label5" runat="server">預設的應用限制：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:RadioButtonList ID="rbLimit" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="Y" Selected="True">開放</asp:ListItem>
