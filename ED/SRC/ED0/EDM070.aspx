...
<%@ Page Language="c#" CodeBehind="EDM070.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM070" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDM070 片語明細維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDM070" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width:5.5em">
                        <asp:Label ID="lbType" runat="server">代碼類別：</asp:Label>
                    </div>
                    <div>
                        <asp:DropDownList ID="dlType" runat="server" Width="9.5em"></asp:DropDownList>
                    </div>
                </div>
            </div>
                    ...
                    <asp:DataGrid ID="dg1" runat="server" PageSize="30" AutoGenerateColumns="False" GridLines="Vertical" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="編號">
                                <ItemTemplate>
                                    <asp:TextBox ID="txNo" runat="server" Width="10em" CssClass="InputUpperFieldText" MaxLength="20"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="描述">
                                <ItemTemplate>
                                    <asp:TextBox ID="txDesc" runat="server" Width="20em" MaxLength="200"></asp:TextBox><!--0960106	Leslie	將MaxLength由40改為200-->
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
