<%@ Page Language="c#" CodeBehind="EDM080.aspx.cs" AutoEventWireup="false" Inherits="ED0.EDM080" %>
...
<body ms_positioning="GridLayout">
    <form id="EDM080" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width:5.5em">
                        <asp:Label ID="lbCodeNo" runat="server" CssClass="KeyField">片語代碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txCodeNo" TabIndex="0" onkeyup="ED_jf_CheckFull()" runat="server" Width="10.5em" CssClass="KeyUpperField" MaxLength="20"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width:5.5em">
                        <asp:Label ID="lbCodeName" runat="server" CssClass="RequireField">片語名稱：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txCodeName" TabIndex="1" runat="server" Width="20.5em" CssClass="RequireField" MaxLength="40"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
