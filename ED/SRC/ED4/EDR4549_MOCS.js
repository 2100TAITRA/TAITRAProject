...
1111122	Kevin	Kevin   1111013	    新增EDR4549_MOCS 公文處理情形統計表
*/
/*****************************************************************************
*
*   Declaration 區
...
function CheckBeforeSearch()
{
    ...
    else if (document.all.hMaxMonth.value != '' && document.all.txYearMonth.value > document.all.hMaxMonth.value)
    {
        strErrMsg += '統計月份不可大於目前統計最大月份';
        $('#txYearmonth').focus();
    }
