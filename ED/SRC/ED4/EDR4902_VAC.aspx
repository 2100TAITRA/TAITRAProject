...
<%@ Page Language="c#" CodeBehind="EDR4902_VAC.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR4902_VAC" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR4902_VAC 民意信箱公文時效天數分析表</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR4902_VAC" onkeyup="jf_CheckFull();" method="post" runat="server">
