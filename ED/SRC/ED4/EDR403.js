 ...
 *	1050523	Kevin		Joe 		1050087	二代公文修改
...
* 
*****************************************************************************/
//1050523 Joe 1050087 二代公文修改，傳入參數event
...
function OnWSResult(argResult)
{
    ...
    if (argResult.id == wsDuplicateID)
    {
		...
		{
			//document.all["txDateS"].value = jf_Trim(argResult.value.RtnStr);
		}
		else
		{
...
function CallBack(argCallerId)
{
	...
	{
		document.all["txDateS"].value = jf_Trim(document.all.lbReturnValue.options[0].value);
