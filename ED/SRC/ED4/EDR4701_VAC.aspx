<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EDR4701_VAC.aspx.cs" Inherits="ED4.EDR4701_VAC" %>

<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<!DOCTYPE html>
<html>
<head>
    <title>EDR4701_VAC 呈閱單位月時效天數明細表列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR4701_VAC" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTDTitle" style="width: 9.5em">
                        <asp:Label ID="Label3" runat="server">呈閱單位：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 15em">
                        <asp:DropDownList ID="dlReviewedDept" TabIndex="240" runat="server" Width="9em">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                        <asp:Label ID="Label2" runat="server">完成別：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 15em">
                        <asp:DropDownList ID="dlCompletedType" TabIndex="240" runat="server" Width="9em">
                        </asp:DropDownList>
                    </div>
                    <div class="dTDTitle" style="width: 9.5em">
                    ...
                    <div class="dTD" style="width: 15em">
                        <asp:DropDownList ID="dlDept" TabIndex="240" runat="server" Width="9em"></asp:DropDownList>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:RadioButton ID="rbDetail" runat="server" Text="明細表" GroupName="rbSummaryType" data-CN="明細表"></asp:RadioButton>
                        <asp:RadioButton ID="rbSummary" runat="server" Text="統計表" GroupName="rbSummaryType" data-CN="統計表"></asp:RadioButton>
                    </div>
                </div>
            </div>
        </div>
