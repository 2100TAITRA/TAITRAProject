<%@ Page Language="c#" CodeBehind="EDR440C1.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR440C1" %>
...
<html>
<head>
    <title>EDR440C1 批示錄案追蹤辦理情形子視窗</title>
...
<body>
    <form id="EDR440C1" onkeyup="jf_CheckFull();" method="post" runat="server">
                    ...
                    <asp:DataGrid ID="dg1" runat="server" CellPadding="0" GridLines="Vertical" AutoGenerateColumns="False" PageSize="30" EnableViewState="False">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="辦理日期">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lbDETAIL_DATE" TabIndex="0" runat="server" Width="7.5em"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="辦理情形">
                                <ItemTemplate>
                                    <asp:Label ID="lbDETAIL_DESC" runat="server" Width="20.5em"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
                    </asp:DataGrid>
