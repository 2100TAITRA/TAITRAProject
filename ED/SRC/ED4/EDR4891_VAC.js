...
1140415 Joe     Daniel  1131346     新增程式
*/
/*****************************************************************************
*
*   Declaration 區
...
function CheckBeforePreview() {
    ...
    if (document.all["txAlertRatio"].value == "") {
        document.all["txAlertRatio"].value = 0;
    }
    if (document.all["txAlertRatio"].value > 100 || document.all["txAlertRatio"].value < 0) {
        alert("警示比率只能輸入0~100的整數");
        return false;
    }
    return true;
}
