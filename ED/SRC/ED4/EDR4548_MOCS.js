...
1111116  Kevin   Joe      1110855   新增程式
*/
/*****************************************************************************
*
*   Declaration 區
...
function jf_CheckPreview() {
	...
	if (document.all.txRcvDateS.value == "" && document.all.txRcvDateE.value == "" && document.all.txDueDateS.value == "" && document.all.txDueDateE.value == "") {
		alert('收文日期、限辦日期不可皆為空白。');
		ReturnValue = false;
	}
	...
	if (document.all.txDueDateS.value == "" && document.all.txDueDateE.value != "")
		...
		var tmp = document.all.txDueDateS.value;
		document.all.txDueDateS.value = document.all.txDueDateE.value;
		document.all.txDueDateE.value = tmp;
	}
