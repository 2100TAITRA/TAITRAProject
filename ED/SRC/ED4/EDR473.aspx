...
<%@ Page language="c#" Codebehind="EDR473.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR473" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>EDR473 未採行線上簽核統計表及清單列印作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM onkeyup="jf_CheckFull();" id="EDR473" method="post" runat="server">
			...
			<DIV id="BaseTable" class="DivBaseTable">
				<DIV id="MainTable" class="DivTable">
					<DIV class="dTR">
						<DIV class="dTDTitle" style="WIDTH: 11em"><asp:label id="Label1" runat="server" CssClass="RequireField">列印月份：</asp:label></DIV>
						<DIV class="dTD"><asp:textbox tabIndex="0" id="txMonthS" runat="server" Width="3em" CssClass="RequireFieldNumeric" 
								 MaxLength="5"></asp:textbox><asp:label id="Label5" style="Z-INDEX: 0" runat="server" Width="16px" CssClass="RequireField"
					...
					<DIV class="dTR">
						<DIV class="dTDTitle" style="WIDTH: 11em"><asp:label id="Label6" runat="server">承辦單位：</asp:label></DIV>
						<DIV class="dTD"><cc1:combobox id="dlDept" style="Z-INDEX: 0" runat="server" Width="8.5em" 
								Rows="10" CssClass="comboBox"></cc1:combobox><cc1:combobox id="dlSect" style="Z-INDEX: 0" runat="server" Width="8.5em" 
								Rows="10" CssClass="comboBox"></cc1:combobox></DIV>
					</DIV>
					<DIV class="dTR">
						<DIV class="dTDTitle" style="WIDTH: 11em"><asp:label id="Label7" runat="server"
								>承辦人：</asp:label></DIV>
						<DIV class="dTD"><cc1:combobox id="dlUser" style="Z-INDEX: 0" runat="server" Width="8.5em" CssClass="comboBox"
								Rows="10"></cc1:combobox></DIV>
					</DIV>
					<DIV class="dTR">
						<DIV class="dTDTitle" style="WIDTH: 11em"><asp:label id="Label2" runat="server"
								 Height="50px">未採行線上簽核原因：</asp:label></DIV>
						<DIV class="dTD">
							<DIV class="GridDiv" style="height: 10em" data-fixed="true">
								<asp:datagrid id="dg1" style="Z-INDEX: 0" runat="server" CellPadding="0" GridLines="Vertical" AutoGenerateColumns="False"
									PageSize="1">
									<Columns>
					...
					<DIV class="dTR">
						<DIV class="dTDTitle" style="WIDTH: 11em"><asp:label id="Label4" runat="server">報表類型：</asp:label></DIV>
						<DIV class="dTD"><asp:radiobutton tabIndex="30" id="rbCount" runat="server"  Checked="True"
								Text="未採行線上簽核統計表" GroupName="Order"></asp:radiobutton><br>
							<asp:radiobutton tabIndex="30" id="rbCountBySect" runat="server"  Text="未採行線上簽核統計表 (含二級單位)"
								GroupName="Order"></asp:radiobutton><br>
							<asp:radiobutton tabIndex="30" id="rbCountByEmp" style="Z-INDEX: 0" runat="server" 
								Text="未採行線上簽核統計表 (含承辦人)" GroupName="Order"></asp:radiobutton><br>
							<asp:radiobutton tabIndex="30" id="rbListByDept" style="Z-INDEX: 0" runat="server" 
								Text="未採行線上簽核公文清單 (依承辦單位分頁)" GroupName="Order"></asp:radiobutton><br>
							<asp:radiobutton tabIndex="30" id="rbListByReason" style="Z-INDEX: 0" runat="server" 
								Text="未採行線上簽核公文清單 (依原因分頁)" GroupName="Order"></asp:radiobutton><br>
							<asp:radiobutton tabIndex="30" id="rbList" style="Z-INDEX: 0" runat="server" 
								Text="未採行線上簽核公文清單 (不分頁)" GroupName="Order"></asp:radiobutton></DIV>
					</DIV>
				</DIV>
