...
<%@ Page Language="c#" CodeBehind="EDT411.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDT411" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDT411 公文列管作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDT411" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div style="z-index: -100; position: absolute; width: 100px; height: 100px; visibility: hidden; top: 0px; left: 0px" id="hiddenDiv">
            ...
            <asp:TextBox ID="txPropertyNo" runat="server"></asp:TextBox>
            <asp:TextBox ID="txBusinessTypeNo" runat="server"></asp:TextBox>
        </div>
        <div id="BaseTable" class="DivBaseTable">
            <div id="MainTable" class="DivTable">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                        <asp:Label ID="Label2" runat="server" CssClass="RequireField">列管日期：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 14.5em">
                        <asp:TextBox ID="txAuditDate" TabIndex="0" runat="server" Width="4em" CssClass="RequireFieldNumeric" MaxLength="20">1234567</asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                        <asp:Label ID="Label3" runat="server" CssClass="RequireField">列管原因：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:DropDownList ID="dlAuditReason" runat="server" Width="12.5em" CssClass="RequireField"></asp:DropDownList>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                    ...
                    <div class="dTD" style="width: 36.5em">
                        <asp:TextBox ID="txAuditRemark" TabIndex="0" runat="server" Width="30.5em"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label ID="Label10" runat="server" CssClass="hide">案件編號：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txCaseNo" TabIndex="-1" runat="server" Width="5.5em"  CssClass="DisplayOnly hide" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                    ...
                    <div class="dTD">
                        ...
                        <asp:TextBox ID="H_txUserName" TabIndex="0" runat="server" CssClass="hide"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txFromSubjuct" TabIndex="0" runat="server" Width="47.5em" CssClass="DisplayOnly" ReadOnly="True"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="DivTable">
                        ...
                        <asp:DataGrid ID="dg1" runat="server" AutoGenerateColumns="False" GridLines="Vertical" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="原因/備註">
                                    <ItemTemplate>
                                        <asp:Label ID="lbRsnRmk" runat="server"></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
                        </asp:DataGrid>
