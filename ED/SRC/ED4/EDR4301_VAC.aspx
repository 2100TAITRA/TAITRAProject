<%@ Page Language="c#" CodeBehind="EDR4301_VAC.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR4301_VAC" %>
...
<html>
<head>
    <title>EDR4301_VAC 所屬(不含醫療)機構公文稽催彙總表</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR4301_VAC" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
				...
				<div class="dTR">
					<div class="dTDTitle" style="WIDTH: 10em">
						<asp:label id="Label4" runat="server">報表自定義表頭：</asp:label>
					</div>
					<div class="dTD" style="width: 15em">
						<asp:TextBox ID="txRptTitle" runat="server" Width="25em" ></asp:TextBox>
					</div>
				</div>
				<div class="dTR">
					<div class="dTDTitle" style="WIDTH: 10em">
