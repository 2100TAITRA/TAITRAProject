<%@ Page Language="c#" CodeBehind="EDR4352_VAC.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR4352_VAC" %>
...
<html>
<head>
    <title>EDR4352_VAC 承辦公文月份別彙總表</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR4352_VAC" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTDTitle" style="width: 5.5em">
                        <asp:Label ID="Label7" runat="server">專案別：</asp:Label>
                    </div>
                    <div class="dTD">
