...
function jf_CheckPreview() {
	let strRcvCloseDateS = $('#txRcvCloseDateS').val();
	let strRcvCloseDateE = $('#txRcvCloseDateE').val();
	...
	if (strRcvCloseDateS == '' && strRcvCloseDateE != '')
		$('#txRcvCloseDateS').val(strRcvCloseDateE);
	else if (strRcvCloseDateS != '' && strRcvCloseDateE == '')
		$('#txRcvCloseDateE').val(strRcvCloseDateS);
	else if (Number(strRcvCloseDateS) > (Number(strRcvCloseDateE))) {
		$('#txRcvCloseDateS').val(strRcvCloseDateE);
		$('#txRcvCloseDateE').val(strRcvCloseDateS);
	}

	if (!ED4.EDR4304_VAC.CheckSearchDays($('#txRcvCloseDateS').val(), $('#txRcvCloseDateE').val()).value)
	{
		alert('查詢範圍最大為90天。');
		return false;
	}
