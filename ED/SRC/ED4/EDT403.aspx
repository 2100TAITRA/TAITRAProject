<%@ Page Language="c#" CodeBehind="EDT403.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDT403" %>
...
<body>
    <form id="EDT403" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="hiddenDiv" style="z-index: -100; left: 0px; visibility: hidden; width: 100px; position: absolute; top: 0px; height: 100px">
            ...
            <asp:TextBox ID="H_MsgId" TabIndex="-1" runat="server" Width="20px"></asp:TextBox>
            <asp:TextBox ID="H_EmpName" TabIndex="-1" runat="server" Width="20px"></asp:TextBox>
            <asp:TextBox ID="H_UserName" TabIndex="-1" runat="server" Width="20px"></asp:TextBox>
            <asp:TextBox ID="H_DeptNo" TabIndex="-1" runat="server" Width="20px"></asp:TextBox>
            <asp:ListBox ID="lbDept" TabIndex="-1" runat="server" Width="20px" CssClass="" Height="22px"></asp:ListBox>
        ...
        <asp:TextBox ID="H_LAST_UPDATE_PROG" runat="server" CssClass="hidden"></asp:TextBox>
        <asp:TextBox ID="H_LAST_UPDATE_TIME" runat="server" CssClass="hidden"></asp:TextBox>
        <div id="BaseTable" class="DivBaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txOSpdNm" TabIndex="-1" runat="server" Width="3.5em" ReadOnly="True" CssClass="DisplayOnly"
                            ForeColor="Navy"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label13" runat="server">申請單單號：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txNDueDate" TabIndex="-1" runat="server" Width="4em" ReadOnly="True" CssClass="DisplayOnly"
                            ForeColor="Navy"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar">
            ...
            <asp:Button ID="btPreview" runat="server" Text="線上瀏覽" Style="display: none" DefaultStyle="newmode:none;modifymode:block;" />
