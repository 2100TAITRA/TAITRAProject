<%@ Page language="c#" Codebehind="EDR432.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR432" %>
<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>EDR432 時效統計週報案件清單列印作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="EDR432" onkeyup="jf_CheckFull();" method="post" runat="server">
					...
					<div class="dTR">
						...
						<div class="dTD">
							<asp:dropdownlist id="dlState" tabIndex="0" runat="server" CssClass="RequireField">
								<asp:ListItem Value="1">辦結</asp:ListItem>
								<asp:ListItem Value="2">依限辦結</asp:ListItem>
								<asp:ListItem Value="3">逾限辦結</asp:ListItem>
								<asp:ListItem Value="4">待辦</asp:ListItem>
								<asp:ListItem Value="5">未逾期待辦</asp:ListItem>
