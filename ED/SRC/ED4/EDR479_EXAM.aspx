...
<%@ Page Language="c#" CodeBehind="EDR479_EXAM.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR479_EXAM" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR479 核判公文統計表查詢作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR479_EXAM" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div style="z-index: -100; position: absolute; width: 100px; height: 100px; visibility: hidden; top: 0px; left: 0px" id="hiddenDiv">
            ...
            <asp:DropdownList ID="dlApproveUser" runat="server" Width="80px"></asp:DropdownList>
        </div>
