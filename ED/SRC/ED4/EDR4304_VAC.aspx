<%@ Page Language="c#" CodeBehind="EDR4304_VAC.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR4304_VAC" %>
...
<html>
<head>
    <title>EDR4304_VAC 所屬(不含醫療)機構電子交換及線上簽核數量統計列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR4304_VAC" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
				<div class="dTR">
					...
					<div class="dTD" style="width: 15em">
						<asp:TextBox ID="txRcvCloseDateS" runat="server" Width="4em" CssClass="RequireField DatePicker" MaxLength="7"></asp:TextBox> - 
						<asp:TextBox ID="txRcvCloseDateE" runat="server" Width="4em" CssClass="RequireField DatePicker" MaxLength="7"></asp:TextBox>
					</div>
				</div>
				<div class="dTR">
					<div class="dTDTitle" style="WIDTH: 10em;">
