...
1010322 Kevin   Ivory   1010190             新增程式
1061027	Kevin	Joe		1050087				二代升級
*/
/*****************************************************************************
*
*   Declaration 區
...
* 
*****************************************************************************/
//1061027	joe		1050087		二代修改配合行動平台
...
* 
*****************************************************************************/
//1061027 Joe 1050087 二代公文修改，傳入參數event
...
function  CheckBeforeRemitting()
{
	...
	if(jf_Trim(document.all.txYearMonth.value) != "")
	{
		...
		if(!jf_CheckCDATE(strMonth + "01"))
		{
			...
			//1061027	Joe	1050087	二代系統升級，調整focus寫法
