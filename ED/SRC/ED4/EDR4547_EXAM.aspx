...
<%@ Page Language="c#" CodeBehind="EDR4547_EXAM.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR4547_EXAM" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR4547 發文時效統計表列印作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR4547_EXAM" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div id="MainTable" class="DivTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txDateY" runat="server" Width="2em" CssClass="RequireFieldNumeric" MaxLength="3"></asp:TextBox>
                        <asp:TextBox ID="txDateS" runat="server" Width="1.5em" CssClass="RequireFieldNumeric" MaxLength="2"></asp:TextBox>~
                        <asp:TextBox ID="txDateE" runat="server" Width="1.5em" CssClass="RequireFieldNumeric" MaxLength="2"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
