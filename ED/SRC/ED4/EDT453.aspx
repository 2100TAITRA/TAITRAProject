...
<%@ Page Language="c#" CodeBehind="EDT453.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDT453" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDT453 存查續辦登錄作業</title>
...
<body>
    <form id="EDT453" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 25.5em">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label5" runat="server">未結案原因：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 25.5em; height: 4em">
                        <asp:TextBox ID="txFurtherReason" runat="server" TextMode="MultiLine" Width="25.5em" Height="3.5em"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
                        <asp:Label ID="Label6" runat="server">續辦文號：</asp:Label>
                    </div>
                    <div class="dTD" style="width: 25.5em">
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar" EnableViewState="False">
            ...
            <asp:Button runat="server" Text="取消" DefaultStyle="newmode:block;modifymode:block;" ID="btCancel"></asp:Button>
