...
<%@ Page Language="c#" CodeBehind="EDR4023.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDR4023" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR4023 公文展期清單列印作業</title>
...
<body>
    <form id="EDR4023" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                        <asp:Label ID="Label2" runat="server"  CssClass="RequireField">核准展期日期：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txSignDateS" runat="server" Width="4em" MaxLength="7" CssClass="RequireFieldNumeric DatePicker"></asp:TextBox>
                        <asp:Label ID="Label6" runat="server">～</asp:Label>
                        <asp:TextBox ID="txSignDateE" runat="server" Width="4em" MaxLength="7" CssClass="RequireFieldNumeric DatePicker"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7.5em">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txNormalFld" runat="server" Width="15em" CssClass="hide" MaxLength="20"></asp:TextBox>
