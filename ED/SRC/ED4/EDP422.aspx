<%@ Page language="c#" Codebehind="EDP422.aspx.cs" AutoEventWireup="false" Inherits="ED4.EDP422" %>
<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML>
<HTML>
	<HEAD>
		<TITLE>EDP422 時效統計解除鎖定作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="EDP422" onkeyup="jf_CheckFull();" method="post" runat="server">
			...
			<DIV class="DivBaseTable" id="BaseTable">
				<DIV class="DivTable" id="MainTable">
					<DIV class="dTR">
						...
						<DIV class="dTD">
							<asp:textbox id="txYearMonth" tabIndex="0" runat="server" Width="4em" CssClass="RequireFieldNumeric" MaxLength="7" ></asp:textbox>
						</DIV>
					</DIV>
