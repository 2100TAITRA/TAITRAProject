<%@ Page Language="c#" CodeBehind="EDI262.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDI262" %>
...
<body ms_positioning="GridLayout">
    <form id="EDI262" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div id="MainTable" class="DivTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txDocNo" TabIndex="0" runat="server" Width="6em" ReadOnly="true" MaxLength="15"></asp:TextBox>
                        <asp:TextBox ID="h_TxDocNo" TabIndex="0" runat="server" Width="8em" CssClass="hide" MaxLength="15"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width:7em">
                        <asp:Label ID="Label2" runat="server" >會簽機關文號：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txOtherDocNo" TabIndex="0" runat="server" Width="6em" ReadOnly="true" MaxLength="15"></asp:TextBox>
                    </div>
                </div>
            </div>
        ...
        <asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar" EnableViewState="False">
            <asp:Button runat="server" style="display:none" Text="關閉" DefaultStyle="newmode:block;modifymode:block;" ID="btClose"></asp:Button>
        </asp:Panel>
    </form>
</body>
</html>
