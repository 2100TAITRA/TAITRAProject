...
<%@ Page Language="c#" CodeBehind="EDR210.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDR210" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDR210 待處理公文查詢作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDR210" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:DropDownList ID="dlDoc" runat="server" Width="5.5em"></asp:DropDownList>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 5.5em">
