<%@ Page language="c#" Codebehind="EDT256.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDT256" %>
<%@ Register TagPrefix="cc1" Namespace="T2100.Web.UI.WebControls" Assembly="WebControl" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<!DOCTYPE HTML >
<HTML>
	<HEAD>
		<TITLE>EDT256 專案通案申請批次核可作業</TITLE>
	...
	<BODY MS_POSITIONING="GridLayout">
		<FORM id="EDT256" onkeyup="jf_CheckFull();" method="post" runat="server">
					...
					<div class="dTR">
						<div class="dTD">
							<asp:Panel ID="tbSelect" runat="server" CssClass="dTD DgSelectToolBar">
								<asp:Button ID="btSelectAll" runat="server" Text="全部" />
								<asp:Button ID="btSelectInverse" runat="server" Text="反向" />
								<asp:Button ID="btSelectClear" runat="server" Text="清除" />
							</asp:Panel>
						</div>
						<div class="dTD">
							<asp:radiobutton style="Z-INDEX: 0" id="rbAppNo" runat="server" Text="依申請單號" Checked="True" GroupName="gSort"></asp:radiobutton>
									...
									<Columns>
										...
										<asp:TemplateColumn HeaderText="申請單號<BR>公文文號">
											<ItemTemplate>
												<P>
													...
													<asp:Label style="Z-INDEX: 0" id="lbUrl" runat="server" Width="0px" CssClass="hidden"></asp:Label><BR>
										...
										<asp:TemplateColumn HeaderText="收創文日期<BR>限辦日期">
											<ItemTemplate>
												...
												<asp:Label style="Z-INDEX: 0" id="lbHTxDate" runat="server" Width="0px" CssClass="hidden"></asp:Label>
											</ItemTemplate>
										</asp:TemplateColumn>
			...
			<asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar">
				...
				<asp:Button ID="btSearch" runat="server" Style="display: none" DefaultStyle="newmode:none;modifymode:none;" />
			</asp:Panel>
		</FORM>
	</BODY>
</HTML>
