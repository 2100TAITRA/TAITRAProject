...
function jf_ToolBarHandle(event)
{
	...
	{
		case "btPrint":
			Page_BlockSubmit = !ConfirmDateValue();
		    //1051129 Zen 1050087 二代公文修改			//jf_ToolBarSubmit();
...
function ConfirmDateValue()
{
	...
	if(CheckCDATE("txDateS","結案日期起"))
	{
		if(CheckCDATE("txDateE","結案日期迄"))
		{
			...
			if(jf_Trim(document.all.txDateE.value)=="" && jf_Trim(document.all.txDateS.value)!="")
