...
1070313 Kevin   Zen     1061349 以ODR240修改，新增EDR2401 辦結日數公文明細表
*/
...
function CheckCondition()
{
    ...
    var strWorkDayS = document.all['txWorkDayS'].value;
    var strWorkDayE = document.all['txWorkDayE'].value;

    if (strWorkDayS == '' && strWorkDayE != '')
        document.all['txWorkDayS'].value = strWorkDayE
    else if (strWorkDayS != '' && strWorkDayE == '')
        document.all['txWorkDayE'].value = strWorkDayS
