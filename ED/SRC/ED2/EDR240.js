 ...
 * 日期		系統分析師	修改人	單號	概要
 * -------------------------------------------------------------------------------------------------
 * 1060726  David       Zen     1050087 二代升級 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/*****************************************************************************
*
*   Declaration 區
* 
...
function jf_ToolBarHandle(event)
{
    ...
    switch (xObjectName)
    {
		...
		//	var strMainTableCol2 = jf_Trim(document.all["txDeptName"].value);
		//	var strMainTableCol3 = escape(jf_Trim(document.all["txSubject"].value));
...
function CallBack(argCallerId)
{
	...
	if(argCallerId == "SII020")
	{
		...
		document.all["txDeptName"].value = jf_Trim(document.all.lbReturnValue.options[2].value);
