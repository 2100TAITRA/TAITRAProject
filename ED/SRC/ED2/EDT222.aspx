...
<%@ Page Language="c#" CodeBehind="EDT222.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDT222" %>

<!DOCTYPE HTML PUBLIC>
<html>
<head>
    <title>EDT222 異動撤銷申請作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDT222" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MTable1">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 10em">
                        ...
                        <asp:TextBox ID="h_txRpsDeptNo" TabIndex="-1" runat="server" Width="1.5em" CssClass="hide"></asp:TextBox>
                    </div>
                    <div class="dTDTitle" style="width: 9.5em">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD" style="width: 30em">
                        ...
                        <asp:TextBox ID="txShowSeqNo" TabIndex="-1" runat="server"  Width="2.5em"></asp:TextBox>
                        <asp:TextBox ID="txSeqNo" TabIndex="-1" runat="server" Width="1.5em" CssClass="hide"></asp:TextBox>
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 9.5em">
                        <asp:Label ID="Label16" runat="server">申請說明：</asp:Label>
                    </div>
                    <div class="dTD">
        ...
        <div id="hiddenDiv" style="z-index: -100; left: 0px; visibility: hidden; width: 100px; position: absolute; top: 0px; height: 100px">
            ...
            <asp:TextBox ID="h_WorkInfo" TabIndex="-1" runat="server" CssClass="hidden" Width="30px"></asp:TextBox>
        </div>
        <asp:Panel ID="tbTool" runat="server" CssClass="V3_GenericBannerToolBar">
            ...
            <asp:Button ID="btPreview" runat="server" Text="預覽申請單" Style="display: none" DefaultStyle="newmode:none;modifymode:block;" />
