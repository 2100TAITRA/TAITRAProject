...
<%@ Page Language="c#" CodeBehind="EDI232.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDI232" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDI232 待匯入基金案件資料查詢作業</title>
...
<body>
    <form id="EDI232" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div id="BaseTable" class="DivBaseTable">
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txRcvDateS" runat="server" Width="4em" MaxLength="7" CssClass="DatePicker"></asp:TextBox>～
                        <asp:TextBox ID="txRcvDateE" runat="server" Width="4em" MaxLength="7" CssClass="DatePicker"></asp:TextBox>
                    </div>
                </div>
            </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="公文文號">
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="lbDocYear" runat="server" CssClass="hide"></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateColumn>
