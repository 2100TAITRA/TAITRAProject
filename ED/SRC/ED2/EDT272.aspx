...
<%@ Page Language="c#" CodeBehind="EDT272.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDT272" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDT272 公文分派作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDT272" onkeyup="jf_CheckFull();" method="post" runat="server">
                        ...
                        <asp:DataGrid ID="dg1" runat="server" PageSize="30" AutoGenerateColumns="False" GridLines="Vertical">
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="文號">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:HyperLink ID="lbdgDocNo" runat="server"></asp:HyperLink>
