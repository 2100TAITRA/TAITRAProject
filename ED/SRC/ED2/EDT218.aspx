...
<%@ Page Language="c#" CodeBehind="EDT218.aspx.cs" AutoEventWireup="false" Inherits="ED2.EDT218" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>EDT218 紙本預排流程設定作業</title>
...
<body ms_positioning="GridLayout">
    <form id="EDT218" onkeyup="jf_CheckFull();" method="post" runat="server">
					...
					<div class="dTR" Style="Height: 4.5em">
						<div class="hide">
							...
							<div class="dTD DgSelectToolBar">
								...
								<asp:Button ID="btAddOld" runat="server" Text="新增"></asp:Button>
							</div>
						</div>
						<div id="CoworkThread" class="hide">
							<div class="dTR">
								<div class="dTDTitle" style="width: 13em">
