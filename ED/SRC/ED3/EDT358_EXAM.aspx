...
<%@ Page Language="c#" CodeBehind="EDT358_EXAM.aspx.cs" AutoEventWireup="false" Inherits="ED3.EDT358_EXAM" %>
...
<body ms_positioning="GridLayout">
    <form id="EDT358_EXAM" onkeyup="jf_CheckFull();" method="post" runat="server">
                ...
                <div class="GridDiv" style="overflow: auto; height: 18.5em">
                    <asp:DataGrid ID="dg1" runat="server" PageSize="50" AutoGenerateColumns="False" GridLines="Vertical" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="機關間人工交換">
                                <ItemTemplate>
