 ...
 * 1111201	 David	Joe		1110902		新增程式
 */
/*****************************************************************************
*
*   Declaration 區
...
function jf_ConfireSearch()
{
	...
	else if (document.all.txIssueDateE.value != "" && document.all.txIssueDateS.value == "")
		document.all.txIssueDateS.value = document.all.txIssueDateE.value;
	if (document.all.txIssueDateS.value != "" && document.all.txIssueDateE.value != "" && document.all.txIssueDateS.value > document.all.txIssueDateE.value) {
		var Temp = document.all.txIssueDateS.value;
		document.all.txIssueDateS.value = document.all.txIssueDateE.value;
		document.all.txIssueDateE.value = Temp;
	}
