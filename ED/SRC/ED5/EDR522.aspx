...
<%@ Page Language="c#" CodeBehind="EDR522.aspx.cs" AutoEventWireup="false" Inherits="ED5.EDR522" %>
<!DOCTYPE HTML>
<html>
<head>
    <title>EDR522 外交部代寄郵件清單列印作業</title>
...
<body>
    <form id="EDR522" onkeyup="jf_CheckFull();" method="post" runat="server">
