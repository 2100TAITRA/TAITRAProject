 ...
 * 日期		 SA           PG           單號	     概要
 * -------------------------------------------------------------------------------------------------
 * 1000825	 David	      Kevin 	   1000713	 新增非發文郵件查詢作業
...
function jf_ToolBarHandle(event)
{
	...
	{
		case "btSearch":
			if(jf_ConfireSearch()) //是否通過儲存前必要檢查
			{
...
function jf_ConfireSearch()
{
	...
	if(!CheckCDATE("txSendDateS","郵寄日期(起)"))
		return false
	if(!CheckCDATE("txSendDateE","郵寄日期(迄)"))
		return false
