...
1150116     David       Daniel  序24		    駐外發文檔案檔名處理
*/
/*****************************************************************************
*
*   Declaration 區
...
//1150116 Daniel  序24 駐外發文檔案檔名處理
//function downLoadFile(argPathID, argFileName) {
function downLoadFile(argPathID, argFileName, argSrcFileName) {
    var strFullPath = document.all[argPathID].textContent;

    //1150116 Daniel  序24 駐外發文檔案檔名處理
    //var result = OM2.OMI200C1.getFiles(strFullPath, argFileName, document.all.txSySid.value, document.all.strSourceOrgno.value).value;
    var result = OM2.OMI200C1.getFiles(strFullPath, argFileName, document.all.txSySid.value, document.all.strSourceOrgno.value, argSrcFileName).value;
...
function DownloadPackageFile() {
    ...
    if (arrFromFile.length == 0)
        ...
        var strZipPath = OM2.OMI200C1.GetPackageFiles(arrFromFile, arrToFile, document.all.txSySid.value, document.all.strSourceOrgno.value).value;
