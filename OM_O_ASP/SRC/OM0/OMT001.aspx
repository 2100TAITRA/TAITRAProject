...
<%@ Page Language="c#" CodeBehind="OMT001.aspx.cs" AutoEventWireup="false" Inherits="OM0.OMT001" %>

<!DOCTYPE HTML>
<html>
<head>
    <title>OMT001 駐外帳號維護作業</title>
...
<body ms_positioning="GridLayout">
    <form id="OMT001" onkeyup="jf_CheckFull();" method="post" runat="server">
            ...
            <div class="DivTable" id="MainTable">
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbOrgNo" runat="server" CssClass="KeyField" ForeColor="Red">隸屬單位：</asp:Label>
                    </div>
                    <div class="dTD">
                ...
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbAccount" runat="server" Width="7em" CssClass="KeyField" ForeColor="Red">帳號：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txAccount" Width="10em" onkeyup="jf_UPPERCASE()" TabIndex="10" runat="server" CssClass="KeyUpperField" MaxLength="20"></asp:TextBox>
                    </div>
                     <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbMima" runat="server" Width="6em">密碼：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txMima" Width="10em" TabIndex="11" runat="server" MaxLength="128" TextMode="Password"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 7em">
                        <asp:Label ID="lbName" runat="server" CssClass="RequireField">名稱：</asp:Label>
                    </div>
                    <div class="dTD">
                        <asp:TextBox ID="txName" runat="server" Width="7em" CssClass="RequireField" TabIndex="12"></asp:TextBox>
                    </div>
                </div>
            </div>
        </div>
