<%@ Page Language="c#" CodeBehind="OMI100C1.aspx.cs" AutoEventWireup="false" Inherits="OM1.OMI100C1" %>
...
<body ms_positioning="GridLayout">
    <form id="OMI100C1" onkeyup="jf_CheckFull();" method="post" runat="server">
        ...
        <div class="DivBaseTable" id="BaseTable">
            <div class="DivTable" id="MainTable">
                ...
                <div class="dTR">
                    ...
                    <div class="dTD">
                        <asp:TextBox ID="txIssueDocNo" TabIndex="1" runat="server" Width="10.5em" MaxLength="15"></asp:TextBox>
                    </div>
                </div>
                <div class="dTR">
                    <div class="dTDTitle" style="width: 6.5em">
