 ...
 * 日期			修改人  單號		概要
 * -------------------------------------------------------------------------------------------------
 * 1120720		Cloud	1120470		調整指令設定至textarea方式
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
function jf_InsertRowToDatagrid(argSql, argRmk)
{
	...
	//* 1120720		Cloud	1120470		調整指令設定至textarea方式
	document.all["dg1__ctl" + len + "_lbNo"].textContent = (len-1).toString();
	...
	txSql.readOnly = true;
	//* 1120720		Cloud	1120470		調整指令設定至textarea方式
	$("#dg1__ctl" + len + "_txSql").val(argSql);
	...
	txRmk.readOnly = true;
	//* 1120720		Cloud	1120470		調整指令設定至textarea方式
	$("#dg1__ctl" + len + "_txRmk").val(argRmk);
}